...
! function(a, b) {
    ...
    return function(a, b, c) {
            ...
            c.noop = function(a) {
                ...
                function d(a) {
                    return void 0 === a || null === a || "number" == typeof a && isNaN(a) ? void 0 : (a.data || a) instanceof Array ? (a.data || a).map(d) : a.hasOwnProperty("value") ? d(a.value) : +a
                }
                return (b && !a.reversed || !b && a.reversed) && (c.reverseData(a), a.reversed = !a.reversed), a.series.map(d)
                ...
                (e || 0 === e) && (j.high = Math.max(e, j.high), j.low = Math.min(e, j.low)), j.valueRange = j.high - j.low, j.oom = c.orderOfMagnitude(j.valueRange), j.step = Math.pow(10, j.oom), j.min = Math.floor(j.low / j.step) * j.step, j.max = Math.ceil(j.high / j.step) * j.step, j.range = j.max - j.min, j.numberOfSteps = Math.round(j.range / j.step);
                ...
                for (j.min = h, j.max = i, j.range = j.max - j.min, j.values = [], g = j.min; g <= j.max; g += j.step) j.values.push(c.roundWithPrecision(g));
                return j
                ...
                var l, m = {};
                if (m[e.units.pos] = a.pos + g[e.units.pos], m[e.counterUnits.pos] = g[e.counterUnits.pos], m[e.units.len] = a.len, m[e.counterUnits.len] = f - 10, j) {
                    var n = '<span class="' + i.join(" ") + '" style="' + e.units.len + ": " + Math.round(m[e.units.len]) + "px; " + e.counterUnits.len + ": " + Math.round(m[e.counterUnits.len]) + 'px">' + d[b] + "</span>";
                    l = h.foreignObject(n, c.extend({
                        style: "overflow: visible;"
                    }, m))
                } else l = h.elem("text", m, i.join(" ")).text(d[b]);
                k.emit("draw", c.extend({
                    type: "label",
                    axis: e,
                    index: b,
                    group: h,
                ...
                k.forEach(function(b, k) {
                    ...
                    (l[k] || 0 === l[k]) && ("x" === a.units.pos ? (b.pos = d.x1 + b.pos, m.x = h.axisX.labelOffset.x, "start" === h.axisX.position ? m.y = d.padding.top + h.axisX.labelOffset.y + (g ? 5 : 20) : m.y = d.y1 + h.axisX.labelOffset.y + (g ? 5 : 20)) : (b.pos = d.y1 - b.pos, m.y = h.axisY.labelOffset.y - (g ? b.len : 0), "start" === h.axisY.position ? m.x = g ? d.padding.left + h.axisY.labelOffset.x : d.x1 - 10 : m.x = d.x2 + h.axisY.labelOffset.x + 10), j.showGrid && c.createGrid(b, k, a, a.gridOffset, d[a.counterUnits.len](), e, [h.classNames.grid, h.classNames[a.units.dir]], i), j.showLabel && c.createLabel(b, k, l, a, j.offset, m, f, [h.classNames.label, h.classNames[a.units.dir], h.classNames[j.position]], g, i))
                })
        ...
        function(a, b, c) {
            ...
            function d(a, b, c) {
                this.units = a, this.counterUnits = a === e.x ? e.y : e.x, this.chartRect = b, this.axisLength = b[a.rectEnd] - b[a.rectStart], this.gridOffset = b[a.rectOffset], this.options = c
            }
            var e = {
                x: {
                    pos: "x",
        ...
        function(a, b, c) {
            ...
            function d(a, b, d) {
                c.LinearScaleAxis["super"].constructor.call(this, a, b, d), this.bounds = c.getBounds(this.axisLength, d.highLow, d.scaleMinSpace, d.referenceValue, d.onlyInteger)
            }
            ...
            c.LinearScaleAxis = c.Axis.extend({
                constructor: d,
                projectValue: e
            })
        }(window, document, a),
        function(a, b, c) {
            ...
            function d(a, b, d) {
                c.StepAxis["super"].constructor.call(this, a, b, d), this.stepLength = this.axisLength / (d.stepCount - (d.stretch ? 1 : 0))
            }

            function e(a, b) {
                return {
                    pos: this.stepLength * b,
                    len: this.stepLength
                }
            }
        ...
        function(a, b, c) {
            ...
            function d(a) {
                ...
                c.createAxis(h, this.data.labels, e, k, j, this.supportsForeignObject, a, this.eventEmitter), c.createAxis(i, i.bounds.values, e, k, j, this.supportsForeignObject, a, this.eventEmitter), this.data.series.forEach(function(f, g) {
                    b[g] = this.svg.elem("g"), b[g].attr({
                        "series-name": f.name,
                        meta: c.serialize(f.meta)
                    }, c.xmlNs.uri), b[g].addClass([a.classNames.series, f.className || a.classNames.series + "-" + c.alphaNumerate(g)].join(" "));
                    var j = [],
                        k = [];
                    ...
                    var l = {
                        ...
                        m = "function" == typeof l.lineSmooth ? l.lineSmooth : l.lineSmooth ? c.Interpolation.cardinal() : c.Interpolation.none(),
                        n = m(j, k);
                    if (l.showPoint && n.pathElements.forEach(function(d) {
                            var e = b[g].elem("line", {
                                x1: d.x,
                                y1: d.y,
                                x2: d.x + .01,
                    ...
                    if (l.showArea) {
                        ...
                        n.splitByCommand("M").filter(function(a) {
                            return a.pathElements.length > 1
                        }).map(function(a) {
                            var b = a.pathElements[0],
                                c = a.pathElements[a.pathElements.length - 1];
                            return a.clone(!0).position(0).remove(1).move(b.x, q).line(b.x, b.y).position(a.pathElements.length + 1).line(c.x, q)
                        }).forEach(function(h) {
                            var i = b[g].elem("path", {
                                d: h.stringify()
        ...
        function(a, b, c) {
            ...
            function d(a) {
                var b, d = [],
                    ...
                    g = a.distributeSeries ? e.map(function(a) {
                        return [a]
                    }) : c.normalizeDataArray(e, this.data.labels.length);
                if (this.svg = c.createSvg(this.container, a.width, a.height, a.classNames.chart + (a.horizontalBars ? " " + a.classNames.horizontalBars : "")), a.stackBars) {
                ...
                var i, j, k, l, m, n = c.createChartRect(this.svg, a, f.padding);
                j = a.distributeSeries && !a.stackBars ? g.length : a.distributeSeries && a.stackBars ? 1 : this.data.labels.length, a.horizontalBars ? (k = m = new c.StepAxis(c.Axis.units.y, n, {
                    stepCount: j
                    ...
                    referenceValue: 0
                })) : (k = l = new c.StepAxis(c.Axis.units.x, n, {
                    stepCount: j
                ...
                var o = this.svg.elem("g").addClass(a.classNames.labelGroup),
                    ...
                    r = [];
                c.createAxis(k, this.data.labels, n, p, o, this.supportsForeignObject, a, this.eventEmitter), c.createAxis(i, i.bounds.values, n, p, o, this.supportsForeignObject, a, this.eventEmitter), this.data.series.forEach(function(b, e) {
                    var f, h = e - (this.data.series.length - 1) / 2;
                    f = a.distributeSeries && !a.stackBars ? k.axisLength / g.length / 2 : a.distributeSeries && a.stackBars ? k.axisLength / 2 : k.axisLength / g[e].length / 2, d[e] = this.svg.elem("g"), d[e].attr({
                        "series-name": b.name,
                        meta: c.serialize(b.meta)
                    }, c.xmlNs.uri), d[e].addClass([a.classNames.series, b.className || a.classNames.series + "-" + c.alphaNumerate(e)].join(" ")), g[e].forEach(function(j, l) {
                        var m, o, p, s;
                        if (s = a.distributeSeries && !a.stackBars ? e : a.distributeSeries && a.stackBars ? 0 : l, m = a.horizontalBars ? {
                            ...
                            }, m[k.units.pos] += f * (a.horizontalBars ? -1 : 1), m[k.units.pos] += a.stackBars || a.distributeSeries ? 0 : h * a.seriesBarDistance * (a.horizontalBars ? -1 : 1), p = r[l] || q, r[l] = p - (q - m[k.counterUnits.pos]), void 0 !== j) {
                            var t = {};
                            t[k.units.pos + "1"] = m[k.units.pos], t[k.units.pos + "2"] = m[k.units.pos], t[k.counterUnits.pos + "1"] = a.stackBars ? p : q, t[k.counterUnits.pos + "2"] = a.stackBars ? r[l] : m[k.counterUnits.pos], o = d[e].elem("line", t, a.classNames.bar).attr({
                                value: j,
