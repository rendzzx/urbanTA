...
class API_Excel_Reader
{
	...
	function __construct()
	{
		...
		$this->CI->load->library('OLE_Read');
		$this->_ole = new OLE_Read();
	...
	function read($sFileName)
	{
		...
		$this->data = $this->_ole->get_work_book();
		$this->_parse();
	}
...
/* End of file core_excel_reader.php */
/* Location: ./application/libraries/core_excel_reader.php */