...
$(document).ready(function(){
    ...
    $("#staffid").change(function(){
        ...
        if(rowid == 0){
             var id = $(this).val()
            $.getJSON("<?php echo base_url('c_user_approval/zoomstaff');?>" + "/" + id, function (data) {
    ...
    $('#savefrm').click(function(event) {
        ...
        if (event.handled !== true) {
            ...
            datafrm.push({name:"id",value:id},{name:"staffid",value:staffid})
                ...
                $.ajax({
                url : "<?php echo base_url('c_user_approval/save_user');?>",
                type:"POST",
                data:datafrm,
                dataType:"json",
...
$.ajax({
  url : "<?php echo base_url('c_user_approval/savePic');?>",
  type:"POST",
  data: function () {
...
function resetpass(){
    ...
    swal({
            ...
            if(event.value){
                $.ajax({
                url : "<?php echo base_url('c_user_approval/resetpass');?>",
                type:"POST",
                data:datafrm,
                dataType:"json",
                success:function(event, data){
...
function loaddata(){
    ...
    if (id > 0) {
        block(true);
        $.getJSON("<?php echo base_url('c_user_approval/getByIDuser');?>" + "/" + id, function (data) {
            console.log(data)
...
function set_dept(dept_cd){
    $.getJSON("<?php echo base_url('c_user_approval/zoomdept');?>" + "/" + dept_cd, function (data) {
            // console.log(data)
...
function set_div(div_cd){
    $.getJSON("<?php echo base_url('c_user_approval/zoomdiv');?>" + "/" + div_cd, function (data) {
            // console.log(data)
