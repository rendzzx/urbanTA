  ...
  <div class="content-wrapper">
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
        <br><br>
        <h3 class="content-header-title">User Access Web and Mobile</h3>
      </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">User Access Web and Mobile</h4>
...
<script type="text/javascript">
    ...
    var tbluser = $('#tbluser').DataTable( {
        "ajax" : {
            "url" : "<?php echo base_url('C_User_Access/gettableuser');?>",
            "type": "POST"
        },
        "columns": [
    ...
    $('#adduser').click(function(){
        ...
        $('#modalbody').load("<?php echo base_url("C_User_Access/adduser")?>");
        $('#modal').data('id', 0);
        $('#modal').modal('show');
    })
