        ...
        <form id ="frmEditor" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
            <div class="box-body">
                <div class="container-fluid">
                    ...
                    <input type="text" id="txtFileattach" name="txtFileattach" value="<?php echo $agent[0]->file_attachment ?>" hidden>
    ...
    <script type="text/javascript">
        ...
        function zoomAgent(no){
            ...
            if(dbprofile!=='' && entitycd!=='' && projectno!=='') {
                var site_url = '<?php echo base_url("c_his_submit_agent/zoom_project_from")?>';
                $.post(site_url,
        ...
        $('#savefrm').click(function(){
            // if($('#frmEditor').valid()){
                ...
                $.ajax({
                    url : "<?php echo base_url('c_his_submit_agent/save_agent');?>",
                    type:"POST",
                      // async: false,
