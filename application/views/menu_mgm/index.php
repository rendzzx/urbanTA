   ...
   tblnewsfeed = $('#tblnewsfeed').DataTable( 
    {
            ...
            buttons: [
                {
                    text: ' Add', className: 'biru-bg fa fa-plus', action: function (e) {
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_menu_mgm/addnew");?>");
        ...
        "serverSide": true,
        "ajax":{
            "url":"<?php echo base_url('c_menu_mgm/getTable');?>",
...
function Delete() {
    ...
    // alert(MenuID);
    $.ajax({
        url : "<?php echo base_url('c_menu_mgm/Delete');?>",
        type:"POST",
        data: { MenuID: MenuID },
        dataType:"json",
...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">  
        <div class="form-group">
            <div class="tittle-top pull-right">Menu MGM Entry</div>
        </div>
    </div>
