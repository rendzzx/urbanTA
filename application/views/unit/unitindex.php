<!-- <link href="<?=base_url('css/plugins/dataTables/jquery.dataTables.min.css');?>" rel="stylesheet" type="text/css" > -->
<!-- <link href="<?=base_url('css/datatable/extensions/Buttons/css/buttons.dataTables.css')?>" rel="stylesheet" /> -->
<!-- <link href="<?=base_url('css/datatable/extensions/Responsive/css/responsive.dataTables.min.css')?>" rel="stylesheet" /> -->
<!-- <link href="<?=base_url('choosen/chosen.min.css')?>" rel="stylesheet" /> -->
<!-- <link href="<?=base_url('css/datatable/extensions/Select/css/select.dataTables.min.css')?>" rel="stylesheet" /> -->

<!-- <script src="<?=base_url('js/datatable/media/js/jquery.dataTables.min.js')?>" type="text/javascript"></script>
<script src="<?=base_url('js/datatable/media/js/dataTables.bootstrap.min.js')?>" type="text/javascript"></script>
<script src="<?=base_url('js/datatable/extensions/Responsive/js/dataTables.responsive.min.js')?>" type="text/javascript"></script>
<script src="<?=base_url('js/datatable/extensions/Select/js/dataTables.select.min.js')?>" type="text/javascript"></script>
<script src="<?=base_url('js/datatable/extensions/Buttons/js/dataTables.buttons.js')?>" type="text/javascript"></script> -->
...
//                 },
                ...
                //     text: ' Unit', className: 'abu-bg fa fa-pencil',
                //     action: function () {
                ...
                //         if(a == ' '){
                //             swal('Only Status Approved can choose Unit');
                //         }else if(status != 'A'){
                //             swal('Only Status Approved can choose Unit');
                //         }else{
                ...
                // },
                {
                    text: ' Back ', className: 'abu-bg fa fa-arrow-left', action: function (e) {
            ...
            {data: "row_number",name:"row_number",searchable:false,orderable:false } , 
            {
              ...
              data: "rowID", name: "rowID",
                            render: function (data, type, row) {
                                ...
                                return  '<a class="btn btn-success btn-sm" onclick="chooseunit(\''+a+'\',\''+status+'\');"><i class="fa fa-pencil fa-fw"></i> Unit</a>';
    ...
    $("div.toolbar").html('<b>Search : <input type="text" class="form-control" style="width: 150px; height: 31px;" id="txt_search"  name="txt_search" > <a class="btn btn-success btn-sm" onclick="fn_search()"><i class="fa fa-search"></i></a> </b>');
...
function cek_attach(seqno,hasil){
    ...
    function invitation(){
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown){
                swal(textStatus+' Send : '+errorThrown);
            }
        });
    }
</script>
