          ...
          function(){
            ...
            $.post(site_url,
                      ...
                      function(data,status) {
                        ...
                        // var a = event.nup_no;
                        // alert(a);
                        window.location.href="<?=base_url('C_nup_dtagentnew/list_dtNew')?>"+"/"+data+"/1/<?php echo $rowid_index?>/<?php echo $status_index?>";
                      }
                    );
                        ...
                        $.ajax({
                          ...
                          success: function(data, status){
                            ...
                            if(data.status=='OK'){
                              ...
                              function(){
                                // return true;
                                window.location.href="<?php echo base_url('c_choose_unit_nup_new/indexNew/')?>";
                              });
                            } else {
                              swal({
                                title: "Error",
