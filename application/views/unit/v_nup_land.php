...
<!-- onclick="reset(this)" -->
               ...
               <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label" style="clear: left;font-size: 13px">Unit</label>
                      ...
                      <input type="hidden" class="form-control" name="payment" id="payment" style="border:none; background-color:white;width: 500px" readonly="readonly" >
...
$('#pl_property').select2();
$('#additional').val('<?php echo $selected_add;?>');
...
function tes() {
  ...
  var getadd = $('#additional').val();
   
   window.location.href="<?php echo base_url('c_nup_landedAgentNew/indextipe/')?><?php echo $NupNO?>/<?php echo $pcd ?>/<?php echo $rowid_index?>/<?php echo $status_index?>/"+newbalance+"/"+rowHeader+"/0/"+getInput+"/"+getpay+"/"+getadd;
}
function test_klik(){
...
if(fn=='A'){
  ...
  if(balance==0){ 
   ...
   else
   {
          ...
          // swal('Information','sdfghjk','warning');  

          $('#usa_image').mapster('highlight', false, IDe);
        }
          }
}else{
   swal({
...
function landinfo(data)
  { 
    ...
    var property_type ='<?php echo $status_index;?>';
    ...
    // alert(pcd);
         var modalClass = $('#modal').attr('class');
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_nup_landedAgentNew/showland");?>"+"/"+data+"/"+property_type);
...
function Booking(){
         ...
         $('#addBookDialog').data('id', lot_no).modal('show');
                            var btnYes = $('<input/>')
                                .attr({
                                    ...
                                    onclick: "Booking2(\'"+lot_no+"\',\'"+xlot_no+"\',\'"+add+"\',\'"+pay+"\');",
                                    value: 'OK'
                                });                            
    ...
    function Booking2(lot_no, xlot_no, add, pay){
          // var LotNumber = $('#txtlotno').val();
          // alert(lot_no);
                            ...
                            if(event.status=='OK'){
                                swal({
                                    ...
                                    function(){
                                        ...
                                        if(b == 'OK'){
                                          window.location.href="<?=base_url('C_nup_dtagentnew/list_dtNew')?>"+"/"+parseNupno+"/1/"+rowid_index+"/"+status_index;  
                                        }else{
