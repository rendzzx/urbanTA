   ...
   tblnewsfeed = $('#tblnewsfeed').DataTable( 
    {
            ...
            buttons: [
                {
                    text: ' Add', className: 'biru-bg fa fa-plus ', action: function (e) {
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_dashentry/addnew");?>");
                        $('#modal').data('action', "add").modal('show');
                    }
                },
                {
        ...
        "serverSide": true,
        "ajax":{
            "url":"<?php echo base_url('c_dashentry/getTable');?>",
...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">  
        <div class="form-group">
            <div class="tittle-top pull-right">Menu Mobile Entry</div>
        </div>
    </div>
