...
$(function(){    
    ...
    $('#group').on("change",function(e){
        ...
        {
            $.ajax({
                url: '<?php echo base_url("c_assignmenu_mobile/getList")?>',
                data: {gid: groupId},
                type: 'post',
                dataType: 'json',
    ...
    table = $('#tblassign').DataTable({
        ...
        serverSide: true,
        ajax:{
            url:"<?php echo base_url('c_assignmenu_mobile/getTable');?>",
    ...
    $('#btnSave').click(function(){
        ...
        if(groupId !== '')
        {
            ...
            $.ajax({
                url: '<?php echo base_url("c_assignmenu_mobile/save");?>',
                data: {models: selData},
                method: 'post',
                dataType: 'json',
            })
...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">  
        <div class="form-group">
            ...
            <div class="tittle-top pull-right">Assign Menu Mobile to Group</div>
        </div><br>
        <div class="form-group">
