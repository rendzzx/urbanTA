  ...
  var rows = tblnewsfeed.rows().indexes();
   ...
   var status_b= false;
    for (var i = 0; i < RowsCount ; i++) {
        ...
        $.ajax({
                    url : "<?php echo base_url('submitSales/addSubmit');?>",
                    type:"POST",
...
<div class="content-wrapper">
    ...
    <div class="form-group">        
        <label for="pl_project" class="col-sm-12 control-label"><?php echo $entityname;?></label>      
    </div>
    ...
    <section class="content" >
        <table id="tblnewsfeed" class="display table-striped table-bordered table-condensed" cellspacing="0" width="100%">
            <thead>            
                <th ><input type="checkbox" id="cbHeader" onclick='cbAll(event)'/></th> <!--onclick='cbAll("View", event)'-->
                <th >Level</th>
                <th width="50%">User</th>
                <th width="50%">Name</th>                
            </thead>
