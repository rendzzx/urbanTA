          ...
          <div class="ibox-content">
            ...
            <div id="MAP" class="box-body" style="overflow-x: scroll;width:100%;">
                <div id="map_demo" style="width:920px; "> 
                    ...
                    <div style="text-align:left; width:100%; height:100%; border:0; float:left; position:relative;">

                    <!-- <img style="width:800px;border:0;" id="usa_image" src="<?php echo base_url();?><?php echo $map_picture;?>" usemap="#usa" > -->

                    <!-- <img style="width:720px;border:0;" id="usa_image" src="<?php echo base_url($map_picture);?>" usemap="#usa" > -->
                    <img style="width:100%;border:0;" id="usa_image" src="<?php echo base_url($map_picture);?>" usemap="#usa" >
                    </div>
...
$('#pl_property').select2();
 ...
 $('#pl_property').on("change",function(e){
    ...
    function openPage(rowid,nupno,pcd){
        ...
        window.location.href="<?php echo base_url('c_nup_landed/indexland/')?>"+"/"+nupno+"/"+rowid+"/"+pcd+"/"+balance;
    }
</script>
