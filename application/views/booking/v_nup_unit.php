              ...
              <section class="content-header">
                <div class="form-group">
                  <div class="pull-left col-sm-8">
                    ...
                    <input type="hidden" class="form-control" name="additional" id="additional" style="border:none; background-color:white;width:80%;" readonly="readonly" value="<?php echo $add; ?>" >
                    <input type="hidden" class="form-control" name="payment" id="payment" style="border:none; background-color:white;width:80%;" readonly="readonly" value="<?php echo $pay; ?>" >
                    
                  </div>
                </div>
                <div class="pull-right">
                  <a href="<?php echo $backurl?>" class="btn abu-bg btn-sm">Back</a> 
                  <button id="btnclear" name="btnclear" onclick="reset(this)" type="button" class="btn btn-danger btn-sm">Clear</button>&nbsp;
...
return false;
  ...
  // function Booking2(lot_no, row_index, xlot_no, pl_property){
    function Booking2(lot_no, row_index, xlot_no,add, pay){
         ...
         $('#addBookDialog').data('id', lot_no).modal('show');
                            var btnYes = $('<input/>')
                                .attr({
                                    ...
                                    onclick: "Booking2(\'"+lot_no+"\',\'"+row_index+"\',\'"+xlot_no+"\',\'"+add+"\',\'"+pay+"\');", 
                                    value: 'OK'                                    
                                });                            
  ...
  function landinfo(lotno, btn)
  {
    ...
    if(true_cl){
      ...
      var arr_pay = payment.split(",");
      var arr_add = additional.split(",");
      var new_pay = ""; var new_add = "";
      txt=arr_lot;
      ...
      // for (i = 0; i <= arr_pay.length; i++) {
      //   if (i == 0){
      //     new_pay = arr_pay[i];
      //   } else if (i == arr_pay.length && payment != "") {
      //     new_pay = new_pay + ',' + payment;
      //   } else if (i == arr_pay.length && payment == "") {
      //     new_pay = payment;
      //   } else {
      //     new_pay = new_pay + ',' + arr_pay[i];
      //   } 
      // }
      //additional
      // for (i = 0; i < arr_add.length; i++) {
      //   if (arr_add[i] != additional && new_add == ""){
      //     new_add = arr_add[i];
      //   } else if (arr_add[i] != payment && new_add != ""){
      //     new_add = new_add + ',' + arr_add[i];
      //   } 
      // }
