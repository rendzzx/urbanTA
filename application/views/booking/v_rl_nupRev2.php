...
<div id="loader" class="loader" hidden="true"></div>
          ...
          <form role="form" class="form-horizontal" enctype="multipart/form-data" id="form_nup" method ="POST" >
            <div class="box-body">             
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="form-control select2 col-sm-2" name="salutation" id="salutation" data-placeholder="Select Salutation">                  
                    <option></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="form-control select2" name="country_cd" id="country_cd" data-placeholder="Select Country"></select>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <select class="form-control select2 col-sm-2" name="nationality" id="nationality" data-placeholder="Select Nationality"><?php echo $cbnationality ?></select>
                </div>
              </div>
              <div class="form-group">
              ...
              <!-- <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select class="form-control chosen-select"  name="Location" id="Location" data-placeholder="Select Location">
                  </select>
                </div>
              </div>-->
              <div class="form-group">
             ...
             <!--  <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <select class="form-control select2"  name="reason_cd" id="reason_cd" data-placeholder="Select Reason"><?php echo $reason ?></select><br>
                </div>
              </div><br><br><br>
  ...
  <!-- <script src="<?=base_url('js/plugins/input-mask/jquery.inputmask.bundle.min.js')?>"></script>  -->
  <!-- <script src="<?=base_url('js/plugins/input-mask/jquery.mask.min.js')?>" type="text/javascript"></script> -->
   ...
   $.validator.addMethod("check_noktp", function (value, element) {
    ...
    $('#form_nup').validate({
      ...
      highlight: function(element, errorClass, validClass){
        ...
        $(element).next("span").addClass("glyphicon-remove glyph-color-red").removeClass("glyphicon-ok");
      },
    ...
    // $("#HP").inputmask({ mask: "999999999999" });
    // $("#HP").inputmask("Regex", { regex: "[0-9]+$" });
    $("#npwp").inputmask({
        mask: '99.999.999.9-999.999'
      });
    $("#nuptype").trigger('change');
    $("#nupamt").inputmask('#,##0',{reverse:true,maxlength:false});
