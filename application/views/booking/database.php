...
$db['default']['hostname']='192.168.0.46';
$db['default']['username']='postgres';
$db['default']['password']='ifcaifca';
$db['default']['database']='energydb';
