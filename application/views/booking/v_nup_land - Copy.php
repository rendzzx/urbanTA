        ...
        <div class="form-group">
        	...
        	<section class="content-header">
                ...
                <div class="pull-right">
                  ...
                  <a href="<?=base_url('c_nup_dt/list_dt/')?>/<?=$NupNO?>" class="btn bg-orange btn-sm">Back</a>  
                </div>                
              </section>
            ...
            <div class="box-body" style="overflow-x: scroll;">
                <div id="map_demo" style="width:920px; ">    
                    <div style="width:720px; border:0; overflow: hidden; float:left;">      
                        <img style="width:800px;border:0;" id="usa_image" src="<?=base_url('img/FloorPlan/IMG_2042.jpg')?>" usemap="#usa" >
                    </div>
...
function test_klik(){
    ...
    <map id="usa_image_map" name="usa">
        <!-- <area id="area1" alt="" title="" href="#" shape="poly" unit="UNIT1" full="Unit 001" coords="197,416,211,390,267,383,287,390,262,438" selected/>
        <area alt="" title="" href="#" shape="poly" unit="UNIT2" full="Unit 002" coords="286,390,313,400,292,444,278,444,264,438" />
        <area alt="" title="" href="#" shape="poly" unit="UNIT3" full="Unit 003" coords="263,306,291,305,296,353,269,356" />
        <area alt="" title="" href="#" shape="poly" unit="UNIT4" full="Unit 004" coords="320,300,351,298,356,345,328,349" />
        <area alt="" title="" href="#" shape="poly" unit="UNIT5" full="Unit 005" coords="379,293,404,293,416,341,386,343" />-->
        <?php echo $dataarea; ?>
    </map>