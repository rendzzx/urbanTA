...
function tes() {
  ...
  var getadd = $('#additional').val();
   ...
   window.location.href="<?php echo base_url('c_nup_landed/indextipe/')?><?php echo $NupNO?>/<?php echo $pcd ?>/<?php echo $rowid_index?>/<?php echo $status_index?>/"+newbalance+"/"+rowHeader+"/<?php echo $unit?>/"+getInput+"/"+getpay+"/"+getadd;
}
function test_klik(){
