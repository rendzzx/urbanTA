        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2"><br/><br/>
            <h3 class="content-header-title">
                <?php echo $project; ?><br/><br/>
            </h3>
            <h4 class="content-header-title">
                <?php echo($agent->agent_name)?> <br>
                  <?php if($status=='N'){echo 'ADD NUP Entry '.$phase->descs;}else{echo 'EDIT NUP Entry '.$phase->descs;} ?></h4>
                          ...
                          <form class="form form-horizontal">
                            <div class="form-body">
                              <div class="form-group row">
                                <label class="col-md-3 label-control">Nama / Name<FONT COLOR="RED">*</FONT></label>
                                <div class="col-md-3">
                                  <select class="form-control col-sm-12" name="salutation" id="salutation" data-placeholder="Select Salutation">                  
                                    <option></option>
                              ...
                              <div class="form-group row">
                                  <label class="col-md-3 label-control">HP / Mobile<FONT COLOR="RED">*</FONT></label>
                                  <div class="col-md-3">
                                    <select class="form-control col-sm-12" name="country_cd" id="country_cd" data-placeholder="Select Country">
                                    </select>
                                  </div>
                                  <div class="col-sm-5">
                               ...
                               <div class="form-group row">
                                <label class="col-md-3 label-control">Email<FONT COLOR="RED">*</FONT></label>
                                <div class="col-sm-3">
                               ...
                               <div class="form-group row">
                                <label class="col-md-3 label-control">Nationality<FONT COLOR="RED">*</FONT></label>
                                <div class="col-sm-3">
                                  <select class="form-control col-sm-12" name="nationality" id="nationality" data-placeholder="Select Salutation"><?php echo $cbnationality ?></select>
                                </div>
                               </div>

                               <div class="form-group row">
                                 <label class="col-sm-3 label-control" name="lblnoktp" id="lblnoktp">No. KTP / ID No.<FONT COLOR="RED">*</FONT></label>
                                 <label class="col-sm-3 labe-control" name="lblnopass" id="lblnopass" hidden="true">No. Passport / Passport No.<FONT COLOR="RED">*</FONT></label>                
                                  <div class="col-sm-3">
                               ...
                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Alamat / Address<FONT COLOR="RED">*</FONT></label>                
                                    <div class="col-sm-8">
                                      <textarea class="form-control" placeholder="Input Address" name="address" id="address" style=" height: 50px;"></textarea>
                                    </div>
                               </div>
                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Kota / City<FONT COLOR="RED">*</FONT></label>                
                                  <div class="col-sm-8">
                                    <select class="form-control"  name="city" id="city" data-placeholder="Select City"></select>
                                  </div>
                               </div> 

                               <div class="form-group row">
                                <label class="col-sm-3 label-control" id="lblnpwp" name="lblnpwp">NPWP</label>                
                                <div class="col-sm-8">
                               ...
                               <div class="form-group row" id="divproduct">
                                <label class="col-sm-3 label-control">Product<FONT COLOR="RED">*</FONT></label>   
                                <div class="col-sm-8">
                                  <?php
                               ...
                               <div class="form-group row">
                                <label class="col-sm-3 label-control" align="right" style="text-align: right">Property<FONT COLOR="RED">*</FONT></label>
                                <div class="col-sm-3">
                               ...
                               <div class="form-group row">
                                <label class="col-sm-3 label-control">Tipe NUP / NUP Type<FONT COLOR="RED">*</FONT> </label>
                                  <div class="col-sm-3">
                               ...
                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Tanggal NUP / NUP Date</label>
                                 <div class="col-sm-3">
                               ...
                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Lokasi launcing yang dipilih /<FONT COLOR="RED">*</FONT><br>Preffered launching location<input type="button" value="More Info" onclick="nuptypeinfo(0);" class="btn btn-info btn-xs"></label>
                                 <div class="col-sm-8">
                                  <select class="form-control" name="Location" id="Location" data-placeholder="Select Location" style="width: 100%;">        
                                  </select>  
                                </div>                
                               </div>

                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Alasan / Reason<FONT COLOR="RED">*</FONT></label>
                                  <div class="col-sm-8">
                                    <select class="form-control"  name="reason_cd" id="reason_cd" data-placeholder="Select Reason"><?php echo $reason ?></select>
                                  </div>
                               </div>
                              <!-- hidden -->
                              ...
                              <!-- end hidden -->
                               ...
                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Upload File<FONT COLOR="RED">*</FONT></label>
                                 <div class="col-sm-8">
                               ...
                               <div class="form-group row">
                                 <label class="col-sm-3 label-control">Cara Pembayaran NUP /<FONT COLOR="RED">*</FONT><br>Payment Method</label>
                                 <div class="col-sm-3">
                                  <select class="form-control" name="payment" id="payment" data-placeholder="Select Payment Method"><?php echo $payment; ?></select>                
                                 </div>
                                 <div class="col-sm-5">
...
function Loadfile(rowID){
              var sn = $('#seqno').val();
                ...
                $('#modalTitle').html('<b>Add File</b>');
                $('div.modal-body').load("<?php echo base_url('c_nup/addNew');?>"); 
                $('#modal').data('sn', sn);
