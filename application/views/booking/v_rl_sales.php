        ...
        <div class="box">
          ...
          <form role="form" class="form-horizontal cmxform" id="form_rl_sales" method ="POST" action="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                 <!--  <select name="unit" id="unit" class="form-control chosen-select" tabindex="2" data-placeholder="Select Unit"><?php echo $combo_unit; ?>
                  ...
                  <!-- <label name="unit" id="unit" class="control-label"><?php echo $lot_no; ?></label> -->
                  <input type="text" style="border:none; background-color:white;" name="unit" id="unit" onchange="tampil_data()" class="control-form" readonly value="<?php echo $lot_no; ?>">
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <button class="btn btn-primary" type="button" id="btnBack" onClick="back_to_unit()"><i ></i> Close</button>
      ...
      if(texts==' Close'){
        // alert(texts+' close');
         $.post(site_url,
              {Id:lot_no},
              function(data,status) {
                window.location.href="<?php echo base_url('c_booking_by_floor');?>";
              }
              );
