          ...
          <div class="ibox-content">
            ...
            <div class="form-group">
              ...
              <section class="content-header">
                ...
                <div class="form-group">
                         <div class="col-xs-10">
                     <label class="col-xs-1 control-label">Land </label>
                     <div class="col-xs-8">
                       <!-- <input type="text" class="form-control" name="name" id="contentnewsfeed" placeholder="Content newsfeed"> -->
                       <!-- <div class="box-body pad"> -->
                        <input type="text" class="form-control" style="width:100%;" name="lot_no2" id="lot_no2" >
                        <input  class="form-control" style="width:10%;" name="b_val" id="b_val" >
                        </input>
                       <!-- </div> -->
                     </div>
                    </div>
...
<!-- onclick="reset(this)" -->
                <div class="pull-right"> 
                  <button id="btnclear" name="btnclear"  type="button" class="btn bg-orange btn-sm">Clear</button>
                  ...
                  <a href="<?=base_url('c_nup_landed/indextipe/')?>/<?php echo $NupNO?>/<?php echo $pcd ?>" class="btn abu-bg btn-sm">Back</a>
            ...
            <div id="MAP" class="box-body" style="overflow-x: auto; width:100%">
            <!-- <div id="MAP" class="box-body" style="width:100%;"> -->
                <div id="map_demo" style="width:920px;"> 
                   ...
                   <div style="width:90%; border:0; float:left; position:relative; ">

                    <img style="width:750px;border:0;" id="usa_image" src="<?php echo base_url();?><?php echo $map_picture;?>" usemap="#usa" >
...
function imgpop(src) {
    ...
    var modalClass = $('#modalimg').attr('class');
                        ...
                        $('#modalBodyimg').html('<img src="'+_src+'" class="image-responsive">');
...
function test_klik(){
    ...
    $(document).ready(function () {
        ...
        default_options =
        {
            fillOpacity: 0.5,
            render_highlight: {
                fillColor: '0066ff',//biru                
                stroke: true
            },
            render_select: {
                fillColor: '66ff33',//hijau   putih: ffffff
                stroke: false
            },
            //render_zoom: {
