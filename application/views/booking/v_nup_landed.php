...
$('#pl_property').select2();
    ...
    $(document).ready(function () {
        ...
        if (newbooking=='1')
        {
            ...
            // var row5 = localStorage.getItem("rowid5");
            // var row4 = localStorage.getItem("rowid4");
            // var comma = '';
            // if (row4 == '')
            // {
            //     comma = '';
 ...
 $('#pl_property').on("change",function(e){
    ...
    function openPage(rowid,nupno,pcd){
       ...
       if (balance=='0')
       {
        ...
        window.location.href="<?php echo base_url('c_nup_landed/indexland/')?>"+nupno+"/"+rowid+"/"+pcd+"/"+rowid_index+"/"+status_index+"/"+balance+"/"+rowHd+"/"+unit+"/"+selected_unit+"/"+selected_pay+"/"+selected_add;
