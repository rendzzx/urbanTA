...
<div class="content-wrapper">
  ...
  <div id="loader" class="loader" hidden="true"></div> 
    <div class="form-group">
      ...
      <div class="tittle-top pull-right"><?php if($status=='N'){echo 'ADD NUP Entry '.$phase->descs;}else{echo 'EDIT NUP Entry '.$phase->descs;} ?> </div>
    </div>        
  </div>
      ...
      <div class="col-xs-12">
        <form role="form" class="form-horizontal" enctype="multipart/form-data" id="form_nup" method ="POST" >
          <div class="ibox-content">
            <div class="form-group">
              <label class="col-sm-3">Nama / Name<FONT COLOR="RED">*</FONT></label>
              <div class="col-sm-3">
            ...
            <div class="form-group">
              <label class="col-sm-3">HP / Mobile<FONT COLOR="RED">*</FONT></label>
              <div class="col-sm-3">
            ...
            <div class="form-group">
              <label class="col-sm-3">Email<FONT COLOR="RED">*</FONT></label>
              <div class="col-sm-7">
            ...
            <div class="form-group">
              <label class="col-sm-3" name="lblnoktp" id="lblnoktp">No. KTP / ID No.<FONT COLOR="RED">*</FONT></label>
              <label class="col-sm-3" name="lblnopass" id="lblnopass" hidden="true">No. Passport / Passport No.<FONT COLOR="RED">*</FONT></label>                 
              <div class="col-sm-7">
                <input type="text" class="form-control" name="noktp" id="noktp" placeholder="Input ID Number">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3">Alamat / Address<FONT COLOR="RED">*</FONT></label>                
              <div class="col-sm-7">
                <textarea class="form-control" placeholder="Input Address" name="address" id="address" style=" height: 50px;"></textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3">Kota / City<FONT COLOR="RED">*</FONT></label>                
              <div class="col-sm-7">
                <select class="select2_demo_2 form-control"  name="city" id="city" data-placeholder="Select City"><?php// echo $comboCity;?></select>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3" id="lblnpwp" name="lblnpwp">NPWP</label>                
              <div class="col-sm-7">
                <input type="text" class="form-control" name="npwp" id="npwp" placeholder="Input NPWP">
              </div>
            </div>
            <div class="form-group" id="divproduct">
              <label class="col-sm-3">Product<FONT COLOR="RED">*</FONT></label>                
              <div class="col-sm-7">                 
                <?php
            ...
            <div class="form-group" >
              <label class="col-sm-3">Property<FONT COLOR="RED">*</FONT></label>
              <div class="col-sm-7">                
            ...
            <div class="form-group">
              <label class="col-sm-3">Tipe NUP / NUP Type<FONT COLOR="RED">*</FONT>
                <input type="button" value="More Info" onclick="nuptypeinfo(1);" class="btn btn-info btn-xs">
              </label>
              <div class="col-sm-3">
                <select class="select2_demo_1 form-control" name="nuptype" id="nuptype" data-placeholder="Select NUP Type">
                <option value=""></option>
            ...
            <div class="form-group" >
              <label class="col-sm-3">Lokasi launcing yang dipilih /<br>Preffered launching location<FONT COLOR="RED">*</FONT>
            ...
            <!-- </div> -->
            <div class="form-group">
              <label class="col-sm-3">Cara Pembayaran NUP /<br>Payment Method</label>
              <div class="col-sm-3">
...
 
  ...
  var descss;
    ...
    $(function() {
      ...
      //                             var url = "<?php echo base_url('img/NUP/')?>"+data;
...
function UploadImage(rowid,el){
        ...
        $.ajax({
                url : "<?php echo base_url('c_nup/saveUpload');?>",
                type:"POST",
                data: function () {
