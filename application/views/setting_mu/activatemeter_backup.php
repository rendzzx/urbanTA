...
<script type="text/javascript">
            ...
            { data: null,
                    ...
                    "render": function (data, type, row) {
                      ...
                      var number = row.rowID
                        if (status == 'Y'){
                            // return '<label class="switch"><input type="checkbox" name="myCheck" checked id="myCheck" onclick="myFunction()" value="'+row.rowID+'"><span class="slider"></span></label>';
                            return '<label class="switch"><input type="checkbox" name="myCheck'+number+'" id="'+number+'" checked onclick="myFunction('+number+')" ><span class="slider"></span></label>';


                        }else{
                            // return 'NOT-ACTIVE';
                            // return '<label class="switch"><input type="checkbox" name="myCheck" id="myCheck" onclick="myFunction()" value="'+row.rowID+'"><span class="slider"></span></label>';
                            return '<label class="switch"><input type="checkbox" name="myCheck'+number+'" id="'+number+'" onclick="myFunction('+number+')"><span class="slider"></span></label>';
    ...
    function formatactive ( d ) {
        ...
        '<div class="col-md-12">'+
            '<div class="row">'+
                '<div class="col-sm-2">'+
                    '<a href=""><img src="http://www.barcodelink.net/barcode.php?url=http://www.ifca.co.id/&size=999 " border="0" alt="Barcode Maker"></a>'+
                    '<label> '+d.rowID+'</label><br>'
                '</div>'
            '</div>'
        '</div>'
        return html
