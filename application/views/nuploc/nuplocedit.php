    ...
    <div class="col-xs-2">
        ...
        <div class="col-xs-2">
            <div id="logo" class="image" >
                <img id="picturebox" height="100" src="<?php echo base_url('img/NUP/'.$pic) ?>" alt="Your Image" />
            </div>
            <span class="btn btn-success fileinput-button">
                <span>Select File...</span>
                <input type="file" id="userfile" name="userfile" accept="image/*" /> <!-- accept="file_extension:,.jpg,.png,.pdf" />  -->
            </span>
            <input type="hidden" id="Picture" name="Picture" value="<?php echo $pic?>" readonly="readonly" />
