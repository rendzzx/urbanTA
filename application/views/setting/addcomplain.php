<form class="form" id="frmdata">
    <div class="form-body">
        <div class="form-group">
            <label for="sectioncd">Complain Code</label>
            <input type="text" id="complaincd" class="form-control" placeholder="Complain Code" name="complaincd" required>
        </div>
        <div class="form-group">
...
<script>
    ...
    $("#modal").on("hidden.bs.modal", function(){
        ...
        $('#savefrm').click(function(){
            ...
            $.ajax({
                url : "<?php echo base_url('C_Setting_Cs/save_complain');?>",
                type:"POST",
                data:datafrm,
                dataType:"json",
    ...
    function loaddata(){
        ...
        if (id > 0) {
            block(true);
            $.getJSON("<?php echo base_url('C_Setting_Cs/getByIDcomplain');?>" + "/" + id, function (data) {
                $('#complaincd').val(data[0].complain_source);
