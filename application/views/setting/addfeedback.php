<form class="form" id="frmdata">
    <div class="form-body">
        <div class="form-group">
            <label for="sectioncd">Feedback Code</label>
            <input type="text" id="feedbackcd" class="form-control" placeholder="Feedback Code" name="feedbackcd" required>
        </div>
        <div class="form-group">
...
<script>
	$(document).ready(function(){
        ...
        $('#savefrm').click(function(){
            ...
            $.ajax({
                url : "<?php echo base_url('C_Setting_Cs/save_feedback');?>",
                type:"POST",
                data:datafrm,
                dataType:"json",
    ...
    function loaddata(){
        ...
        if (id > 0) {
            block(true);
            $.getJSON("<?php echo base_url('C_Setting_Cs/getByIDfeedback');?>" + "/" + id, function (data) {
                $('#feedbackcd').val(data[0].code);
