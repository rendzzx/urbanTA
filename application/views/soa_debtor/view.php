...
if(!empty($dtHeader)){
    ...
    <section class="row border-bottom white-bg dashboard-header">
            ...
            <div class="form-group">
                    ...
                    <a href="<?php echo base_url('c_soa_debtor/printview/').$debtor.'/'.$entity.'/'.$project?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print </a>
              </div>
    </section>
        <div class="row">
            <div class="col-lg-12">
...
<script type="text/javascript">
    function back(){
        window.location.href="<?php echo base_url('c_soa_debtor/index')?>";
    }
    function download(){
        ...
        console.log(pdf);
          ...
          var site_url = '<?php echo base_url("c_soa_debtor/createpdf")?>';
          $.post(site_url,{project:project,debtor:debtor,entity:entity},
            function(data){
                // return;
              window.location.href="<?php echo base_url('c_soa_debtor/download')?>/"+pdf;
