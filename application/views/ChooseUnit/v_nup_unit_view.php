      ...
      <div class="row border-bottom white-bg dashboard-header">
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <!-- <div class="col-sm-2">
                      <button type="button" id="btnOrange" name ="btnOrange" style="width: 100px;margin-bottom: 5px; margin-top: 5px; margin-left: 5px; margin-right: 5px;background:#FF8000;" class = "btn btn"  >Hold</button>
                    </div>
                    <div class="col-sm-2">
...
$('#table1').load( "<?php echo base_url('C_nup_unitNew/goto_tableView');?> #table1",{"property_cd":property_cd,"level_no":level_no,"Type":Type} );
});
