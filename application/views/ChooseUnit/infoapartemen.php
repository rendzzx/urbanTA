                            ...
                            if(event.status=='OK'){
                                swal({
                                    ...
                                    function(){
                                        ...
                                        var b = event.notif;
                          if(b == 'OK'){
                                          window.location.href="<?=base_url('c_nup_dtNew/list_dtNew/')?>"+"/"+parseNupno+"/1/"+rowid_index;  
                                        }else{
                                          window.location.href="<?=base_url('c_choose_unit/indexNew/')?>";  
                                        }
                                    });
                            } else {
                                swal({
