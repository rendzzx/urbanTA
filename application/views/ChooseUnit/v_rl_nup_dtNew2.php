    ...
    <div id="loader" class="loader" hidden="true"></div> 
      ...
      function delete_1(rowid,lotno){ 
         swal({
          ...
          function(){
            var site_url = '<?php echo base_url("c_nup_dtNew/delete")?>';
            $.post(site_url,
                      {rowID:rowid},
                      function(data,status) {
                       
                        window.location.href="<?=base_url('c_nup_dtNew/list_dtNew')?>"+"/"+data+"/1/<?php echo $rowid_index?>/<?php echo $status_index?>";
                      }
                    );
      ...
      function ChooseUnit(RowId,balance,NupNO){        
        ...
        window.location.href = url;
              ...
              //         var site_url = '<?php echo base_url("c_nup_dtNew/chosen_country")?>';
              //             $.post(site_url,
              //               {Id:Id},
              //               function(data,status) {
              //                 $("#country_cd").empty();
...
// alert(rowID);
              ...
              var sn = $('#seqno').val();
                ...
                // alert(rowID);
                $('div.modal-body').load("<?php echo base_url('c_nup_dtNew/addNew');?>"); //+"/"+descs+"/"+rowID);
...
function Loaddata() {
  ...
  var ID = '<?php echo $rowID;?>';
                ...
                onStepChanging: function (event, currentIndex, newIndex)
                {
                   ...
                   var chosen = '<?php echo $TotQty; ?>';
                    ...
                    if(newIndex === 2 && currentIndex === 1){
                      ...
                      //   var site_url = "<?php echo base_url('c_nup_dtNew/savenup2')?>";
                      //   // var home = "<?php echo base_url('c_choose_unit/indexNew')?>";
                      //   $.ajax({
                      //     url: site_url,
                      //     type: "POST",
                      //     data: dataform,
                        ...
                        $.ajax({
                          ...
                          success: function(data, status){
                            ...
                            if(status=='success'){
                              ...
                              function(){
                                // return true;
                                window.location.href="<?php echo base_url('c_choose_unit/indexNew/')?>";
                              });
                            } else {
                              swal({
                                title: "Error",
        ...
        "scrollX": true,
        ajax:{
            url:"<?php echo base_url('c_nup_dtNew/getTableAttachDoc')?>",
            ...
            },
            {
              ...
              // data: null, searchable:false,
                            render: function (data, type, row) {
                                ...
                                return '<a class="btn btn-primary btn-sm" href=' +'<?php echo base_url("c_nup_dtNew/downloadFile")?>'+'/'+seqno+'/'+document_no+'><i class="fa fa-download"></i> Download</a>';                                
  ...
  { 
    // var balance = $('#b_val').val();
          var modalClass = $('#modal').attr('class');
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_nup_dtNew/showland/");?>"+lotno+"/"+rowid+"/"+nup_no+"/"+balance+"/"+rowid_index+"/"+status);
