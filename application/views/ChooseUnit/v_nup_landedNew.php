      ...
      <div class="row">      
        <div class="col-xs-12">        
          ...
          <div class="form-group">
            ...
            <input type="hidden" class="form-control" name="pay" id="pay" style="border:none; background-color:white;" readonly="readonly">
            </div>
                            ...
                            if(event.status=='OK'){
                                swal({
                                    ...
                                    function(){
                                        ...
                                        if(b == 'OK'){
                                          window.location.href="<?=base_url('c_nup_dt/list_dtNew/')?>"+"/"+a+"/1/"+rowid_index+"/"+status_index;  
                                        }else{
...
$('#pl_property').select2();
 ...
 $('#pl_property').on("change",function(e){
    ...
    window.location.href = "<?php echo base_url('c_nup_landed/indextipe');?>"+"/"+nupno+"/"+property_cd+"/"+balance;
    ...
    function openPage(rowid,nupno,pcd){
       ...
       if (balance=='0')
       {
        ...
        var _Url = "<?php echo base_url('c_nup_landedNew/indexland/')?>"+nupno+"/"+rowid+"/"+pcd+"/"+rowid_index+"/"+status_index+"/"+balance+"/"+rowHd+"/"+unit+"/"+selected_unit+"/"+selected_pay;
        // alert(_Url);
