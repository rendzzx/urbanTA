...
<div class="app-content content">
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
              <br><br>
              <h3 class="content-header-title">Menu Approval</h3>
            </div>
            ...
            <div class="content-header-right col-md-8 col-12 mb-2">
                ...
                <div class="breadcrumbs-top float-md-right">
                    <div class="breadcrumb-wrapper mr-1">
                        ...
                        <li class="breadcrumb-item active">Menu Approval
                        </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <!-- <h4 class="card-title">Menu Approval</h4> -->
    ...
    var tblnewsfeed = $('#tblnewsfeed').DataTable( {
        "ajax" : {
            "url" : "<?php echo base_url('c_menu_approval/getTable');?>",
            "type": "POST"
        },
        "columns": [
...
$('#addnewsfeed').click(function(){
    // var site_url = '<?php echo base_url("c_menu_approval/addnew/")?>'+0;
    // window.location.href= site_url;
    $('#modalheader').removeClass('bg-info').addClass('bg-primary white');
    $('#modaltitle').addClass('white');
    $('#modaltitle').html('Menu Entry');
    $('#modalbody').load("<?php echo base_url("c_menu_approval/addnew");?>");
...
$('#editnewsfeed').click(function(){
    ...
    var site_url = '<?php echo base_url("c_menu_approval/addnew/")?>'+menuID;
    // window.location.href= site_url;    
...
function Delete(id) {
   ...
   block(true,'.content-body');
    $.ajax({
        url : "<?php echo base_url('c_menu_approval/delete');?>",
        type:"POST",
        data: { id: id },
        dataType:"json",
