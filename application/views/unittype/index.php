...
var tblgallery;
$(function(){
   tblgallery = $('#tblgallery').DataTable( 
    {
            ...
            buttons: [
                {
                    text: ' Add', className: 'biru-bg fa fa-plus ', action: function (e) {
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_gallery/add");?>");
        ...
        "columns": [
            ...
            {data:"gallery_url",name:"gallery_url"},
        ]
    });
...
function Delete() {
    ...
    $.ajax({
        url : "<?php echo base_url('c_gallery/Delete');?>",
        type:"POST",
        data: { id: id },
        dataType:"json",
