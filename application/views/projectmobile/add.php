...
.has-error .radio-inline {
  ...
  border-radius: 4px;
        ...
        <div class="content-wrapper-before" style="height: 150px !Important"></div>
         <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <br>
            <h3 class="content-header-title">Registration New Project</h3>
          </div>
        </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <select name="db_profile" id="db_profile" data-placeholder="Choose a Profile..." class="form-control select2" tabindex="2">
                                  <option value=""></option>
                                  <option value="IFCAPB">PIM</option>
                                  <option value="IFCAPB2">PP</option>
    ...
    $("#btnback").click(function(){
      location.href = "<?php echo base_url('c_projects/index'); ?>";
    })

    $("#db_profile").change(function(){
      var db = $(this).find(":selected").val();
      if(db=='IFCAPB'){
        $('#db_name').val('alfa_prop_live');
      }else{
         $('#db_name').val('alfa_hosp_live');
      }
                    ...
                    success:function(event, data){
                      ...
                      if(event.status=='OK'){
                        ...
                        swal({
                          ...
                          window.location.href="<?php echo base_url('c_projects/index');?>";
                        });
      ...
      function loaddata(){
        ...
        if (rowID > 0) {
          ...
          $.getJSON("<?php echo base_url('c_projects/getByID');?>" + "/" + rowID, function (data) {
              ...
              $('#picturebox1').attr('src', data[0].picture_path);
              $('#picturebox2').attr('src', data[0].picture_url);
