        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto;" class="email-container">
            ...
            <tr>
                <td style="background-color: #00BFFF;">
                    <img src="http://35.198.219.220:2121/panen-web/img/email/logo.png" width="600">
                    <!-- <hr> -->
                </td>
            </tr>
...
<!--                             		data-html="true" data-trigger="hover" data-toggle="popover" data-placement="auto right"  data-content="'.$title.'" -->
            ...
            <tr>
                <td style="background-color: #00BFFF;padding: 20px" id="footer">
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $('#save2').click(function(){
            var code = $('#footer').summernote('code');
            $('#footer').summernote('code', code);
            $('#footer').summernote('destroy')
            $('#save2').hide();
        })
		$('#back').click(function(){
