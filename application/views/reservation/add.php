        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <label class="radio-inline"><input type="radio" name="Txtstatus" id="Txtstatus" value="0">Obselete </label>    
                </div>                                
            </div>
        </div>                  
   ...
   $('#modal').one('shown.bs.modal', function (e) {
        ...
        if (nup_id > 0) {
            $.getJSON("<?php echo base_url('c_nup_parameter/getByID');?>" + "/" + nup_id, function (data) {
                ...
                // alert(tes);
                $('#TxtentityCode').val(data[0].entity_name);
                $('#TxtprojectNo').val(data[0].project_name);
                $('#TxtphaseCode').val(data[0].phase_descs);
