...
function back(){
 ...
 window.location.href="<?php echo base_url('c_reservation/indextipe/')?><?php echo $pcd ?>/";
}
function tes() {
  window.location.href="<?php echo base_url('c_reservation/indextipe/')?><?php echo $pcd ?>";
  ...
  { 
    ...
    // alert(pcd);
         var modalClass = $('#modal').attr('class');
                        ...
                        // alert(property_type);
                        // alert(pcd);
                        $('div.modal-body').load("<?php echo base_url("c_reservation/showland");?>"+"/"+data +"/"+type);
