            ...
            buttons: [
                ...
                // },
                {
                    text: ' New Reguler', className: "biru-bg fa fa-plus "+x, action: function (e) {
                       ...
                       //  var status='I';
                        var site_url = '<?php echo base_url("c_nup_landed_cfld/index")?>';
                ...
                },
                {
                    text: ' New Prioritas', className: "biru-bg fa fa-plus "+x, action: function (e) {
                        ...
                        var site_url = '<?php echo base_url("c_nup_landed_cfld/indexPrior")?>';
                            window.location.href= site_url;
                    }
                },
                {
                    ...
                    action: function () {
                        ...
                        var site_url = '<?php echo base_url("c_nup_cfld/edit_rev")?>'+'/'+status+'/'+ID+'/'+HeaderID+'/'+type+'/W';
                        // var site_url = '<?php echo base_url("c_nup_cfld/edit_rev")?>'+'/'+status+'/'+ID+'/'+headerID+'/'+Ro_type+'/W';
              ...
              data: "rowID", name: "rowID",
                            render: function (data, type, row) {
                              ...
                              // return status;
                               ...
                               // if(status == 'P'){
                               //  return '<a class="btn btn-success btn-sm" onclick="klikcubmitnon(\''+data+'\',\''+seq_no+'\',\''+status+'\',\''+headerID+'\');"" ><i class="fa fa-users fa-fw"></i> Submit</a>';
                               // } else {
                               //  return '<a class="btn btn-success btn-sm hidden" onclick="klikcubmitnon(\''+data+'\',\''+seq_no+'\',\''+status+'\',\''+headerID+'\');"" ><i class="fa fa-users fa-fw"></i> Submit</a>';
                               // }
    ...
    function Submit11(){
        ...
        document.getElementById('loader').hidden=false;
         ...
         $.ajax({
                    url : "<?php echo base_url('c_nup_cfld/SubmitStatus');?>",
                    type:"POST",
                    data: { id:id,status:status,HeaderID:headerID},
                    dataType:"json",
                    success:function(event, data){
                        document.getElementById('loader').hidden=true;
                        console.log(event);
...
// // $var.=" console.log(data); return;";
// $var.="                        var status = data[0].STATUS;";
// $var.="                        var ID = data[0].rowID;                        ";


// $var.="                        var HeaderID = data[0].HeaderID; ";
// // $var.="                        var type = data[0].nup_type; ";
// // $var.="                        if(type=='ROI '){ type = 'R'; }else{ type = 'P'; } ";
...
// $var.="                        var site_url = '".base_url("c_nup_cfld/edit_rev_a")."'+'/'+status+'/'+ID; ";
// // $var.="                        var site_url = '".base_url("c_nup_cfld/edit_rev_a")."'+'/'+status+'/'+ID+'/'+HeaderID+'/'+type+'/W';";              
