...
var tblnewsfeed = $('#tblnewsfeed').DataTable( {
        "ajax" : {
            "url" : "<?php echo base_url('c_user_history/getTable');?>",
            "type": "POST"
        },
        "columns": [
    ...
    $('#add').click(function(){
    var site_url = '<?php echo base_url("c_user_history/form/add")?>';
    window.location.href= site_url;
        // $('#modalheader').removeClass('bg-info').addClass('bg-primary white');
        // $('#modaltitle').addClass('white');
        // $('#modaltitle').html('Add Plan');
        // $('#modalbody').load("<?php echo base_url("c_user_history/addnew");?>");
        // $('#modal').data('id', 0);
        // $('#modal').modal('show');
    })
    $('#edit').click(function(){
        ...
        var site_url = '<?php echo base_url("c_user_history/form/edit")?>'+ "/" +rowID;
        window.location.href= site_url;    

        // $('#modalheader').removeClass('bg-primary').addClass('bg-info white');
        // $('#modaltitle').addClass('white');
        // $('#modaltitle').html('Edit Plan');
        // $('#modalbody').load("<?php echo base_url("c_user_history/addnew/")?>'+rowID");
