    ...
    <label class="control-label" style="font-size:15px;">Filter</label>
        ...
        <input type="hidden" name="cl_colour" id="cl_colour" width="100%" value='<?php echo $ms_colour;?>' class="form-control" >
             ...
             <div class="pull-right" >
                ...
                <a class="btn btn-success btn-sm" onclick="fn_search();" style=" width: auto">Search <i class="fa fa-search"></i></a>
                <a class="btn btn-success btn-sm" onclick="fn_Clearsearch();" style=" width: auto">Clear Filter</a>
                <!-- <input type="button" name="btnNext" id="btnNext" value="Process" class="btn btn-success btn-bg"> -->
            </div>
        </div>
    </div><br>
    <div class="row border-bottom white-bg dashboard-header">
    ...
    var lot_descs = $('#lot_descs').val();
        var Cluster_cd = '<?php echo $Cluster_cd?>';
         var modalClass = $('#modal').attr('class');
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_mobile_cfld/showland");?>"+"/"+data);
