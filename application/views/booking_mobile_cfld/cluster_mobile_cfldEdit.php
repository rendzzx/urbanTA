...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">  
        <div class="form-group">
            ...
            <div class="tittle-top pull-right"><b>Prioritas</b></div>
        </div>
    </div>
...
window.location.href = "<?php echo base_url('c_mobile_cfld/ClusterLandedEdit')?>"+'/'+cluster_cd+'/'+Type;
}
$(document).ready(function(){
  var typee = '<?php echo $Type;?>';
  var ulrr = "<?php echo base_url('c_mobile_cfld/property_image/');?>"+typee;

  $('#property_div').load( ulrr+" #property_div");
