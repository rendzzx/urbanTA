                                        ...
                                        <div class="row">    
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="row">
                                                            <label for="pl_project" class="col-xs-2 control-label" style="padding-left:0px;"> Choose Project</label>
                                                                <div class="col-sm-3">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="row">
                                                            <label for="pl_project" class="col-xs-2 control-label" style="padding-left:0px;"> Choose Debtor</label>
                                                                <div class="col-sm-2">
