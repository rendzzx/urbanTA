...
<div class="content-wrapper">
	<div class="row border-bottom white-bg dashboard-header">  
		<div class="form-group">
			<div class="tittle-top pull-right"><b>Debtor Agent Summary</b></div>
            ...
            <div class="col-xs-12">
                <div class="ibox-content">
                    <div class="table-responsive">                       
                        ...
                        <br>    
                        <div class=" FixedHeader_Cloned fixedFooter FixedHeader_Footer">                         
   ...
   tblcount = $('#tblcount').DataTable( 
    {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            // data = api.column( 14 ).cache('search');
            // total = data.length ?
    ...
    new FixedHeader( tblcount, { "bottom": true } );
});
function fn_search(){
    var a = $('#txt_search').val();
    tblcount.ajax.reload(null,true); 
