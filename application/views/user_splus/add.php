            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group staff">
                        ...
                        <input type="text" id="UserID" class="form-control" placeholder="UserID" name="UserID" disabled>
           
                    </div>
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" id="staffname" class="form-control" placeholder="Name" name="staffname" disabled>
                    </div>
                    <div class="form-group">
                        <label for="name">Email</label>
                        <input type="text" id="email" class="form-control" placeholder="Email" name="email" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="divsosmed">
                        <label for="coname">Sign in via Social Media</label>
                        <input type="text" id="sosmed" class="form-control" name="sosmed" disabled>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="coname">Status User</label>
...
$(document).ready(function(){
    ...
    $("#staffid").change(function(){
        ...
        if(rowid == 0){
            var id = $(this).val()
            if(id){
                $.getJSON("<?php echo base_url('c_user_splus/zoomstaff');?>" + "/" + id, function (data) {
    ...
    $('#savefrm').click(function(event) {
        ...
        if (event.handled !== true) {
            ...
            datafrm.push({name:"id",value:id},
                ...
                {name:"staffname",value:staffname},
                {name:"meter",value:meter}
                )

            // console.log(datafrm);return;
                $.ajax({
                url : "<?php echo base_url('c_user_splus/save_user');?>",
                type:"POST",
                data:datafrm,
                dataType:"json",
                success:function(event, data){
                    if(event.Error==false){
                        ...
                        tblguest.ajax.reload(null,true);
                    }
                    else {
                        block(false);
                        swal({
...
$.ajax({
  url : "<?php echo base_url('c_user_splus/savePic');?>",
  type:"POST",
  data: function () {
...
function resetpass(){
    ...
    swal({
            ...
            if(event.value){
                $.ajax({
                url : "<?php echo base_url('c_user_splus/resetpass');?>",
                type:"POST",
                data:datafrm,
                dataType:"json",
                success:function(event, data){
...
function loaddata(){
    ...
    if (id > 0) {
        block(true);
        $.getJSON("<?php echo base_url('c_user_splus/getByIDuser');?>" + "/" + id, function (data) {
            console.log(data)
...
function set_dept(dept_cd){
    if(dept_cd){
        $.getJSON("<?php echo base_url('c_user_splus/zoomdept');?>" + "/" + dept_cd, function (data) {
            // console.log(data)
...
function set_div(div_cd){
    if(div_cd){
        $.getJSON("<?php echo base_url('c_user_splus/zoomdiv');?>" + "/" + div_cd, function (data) {
            // console.log(data)
            if(data){
