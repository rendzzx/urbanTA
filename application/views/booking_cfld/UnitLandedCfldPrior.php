...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">
        <div class="form-group">
            ...
            <div class="tittle-top pull-right">Prioritas</div>
        </div>
    </div>
...
function openPage(rowid,property_cd,unit){
  ...
  window.location.href="<?php echo base_url('C_nup_landed_cfld_dt/data_unit_landdtPrior')?>"+"/"+rowid+"/"+property_cd+"/"+unit;
    ...
    $('#btnNext').click(function() {
            ...
            $.ajax({
                ...
                success: function(data, status) {
                    var busID = '<?php echo $business_id;?>';
                    window.location.href = "<?php echo base_url('c_nup_cfld/insert/N/P')?>/"; //+'/'+property_cd+'/'+myBookId;
