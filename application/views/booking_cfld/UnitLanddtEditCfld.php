...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">
        <div class="form-group">
            ...
            <div class="tittle-top pull-right"><b>ROI</b></div>
        </div>
    </div><br>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#911010', endColorstr='#911010', GradientType=1 );
 color: white;  box-shadow: 0 5px 10px 0 rgba(0, 0, 0,0.30), 0 15px 5px 0 rgba(0, 0, 0, 0.15);">
    <label class="control-label" style="font-size:15px;">Filter</label>
        <div class="form-group">            
            <div class="col-sm-12">
                <label for="pl_project" class="col-sm-2 control-label">Facing :</label>
                <div class="col-sm-10">
            ...
            <div class="col-sm-12">
                <label for="pl_project" class="col-sm-2 control-label">Type :</label>
                <div class="col-sm-10">
            ...
            <!-- <div class="col-sm-12">
                <label for="pl_project" class="col-sm-2 control-label">Price :</label>
                <div class="col-sm-10">
                    <select name="txtPrice" id="txtPrice" data-placeholder="Select Price..." class="select2 form-control" tabindex="2">
                        ...
                        <option value="2">501.000.000 - 700.000.000</option>
                        <option value="3">701.000.000 - 1000.000.000</option>
                        <option value="4"> > 1000.000.000</option>
                    </select> 
                </div>                
            </div> -->
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <!-- <label for="pl_project" class="col-sm-2 control-label">css :</label> -->
                <div class="col-sm-10">
        <input type="hidden" name="cl_colour" id="cl_colour" width="100%" value='<?php echo $ms_colour;?>' class="form-control" >
             ...
             <div class="col-sm-12">
                ...
                <a class="btn blue-bg btn-sm pull-right" onclick="fn_search();" style=" width: auto">Search <i class="fa fa-search"></i></a>
                <a class="btn blue-bg btn-sm pull-right" onclick="fn_Clearsearch();" style=" width: auto">Clear Filter</a>
            </div>
        </div>
    </div><br>
    <div class="row border-bottom white-bg dashboard-header">
                                    ...
                                    <form name="basicform" id="basicform" class="form-horizontal" method="post" action="#">
                                        ...
                                        <div class="box-body">
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <label for="pl_project" class="col-sm-2 control-label">Direction :</label>
                                                    <div class="col-sm-8">
                                                        <select name="txtDirection" id="txtDirection" data-placeholder="Select Direction..." class="select2 form-control" tabindex="2">
                                                            <option value=""></option>
                                                        </select> 
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                 ...
                                                 <div class="col-sm-12">
                                                    <a class="btn blue-bg btn-sm" onclick="fn_search();" style=" width: auto">Search <i class="fa fa-search"></i></a>
                                                    <a class="btn blue-bg btn-sm" onclick="fn_Clearsearch();" style=" width: auto">Clar Filter</a>
                                                </div>
                                            </div> -->
                                            <!-- <hr> -->
                                            <div class="col-sm-8">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <textarea name="lot_descs" id="lot_descs" class="form-control" style="border:none; background-color:white; color:#ec0303;width:100%;font-size: large;" readonly="readonly" rows="2"></textarea>
     ...
     var $statelist, $usamap, ratio;
        ...
        var default_options =
        {
            ...
            onClick: function (e) {
                ...
                $(this).parent().parent().find("area").each(function(){
                    ...
                    // var descss = $(this).attr("data-descs");  
            ...
            onConfigured: function () {                
                 // askColour(function(colour){
                    // console.log(colour["A0"]);

                    // $(this).parent().parent().find("area").each(function(colour){                        
                    //    var type = $(this).attr("data-status");                    
                    //     $(this).mapster('set',true,_colour[type]);
                    //     // console.log(_colour[type]);
                    //     // $(this).mapster('set',true,data[type]);
                    ...
                    $(this).parent().parent().find("area").each(function(){         
                       ...
                       // console.log(dataWarna[type]["fillColor"]);
                        ...
                        // $(this).mapster('set',true,dataWarna[type]["fillColor"]);
                        if(Aktif=='A'){
      ...
      // console.log(render);
        ...
        $('#btnNext').click(function() {
            ...
            var property_cd = '<?php echo $property_cd;?>';
            var headerid_ = '<?php echo $headerid; ?>';
            var headerid = 1000000 + parseInt(headerid_);
            // alert(headerid);
            // return;
            ...
            $.ajax({
                ...
                success: function(data, status) {
                    ...
                    // window.location.href = "<?php echo base_url('c_nup_cfld/insert/N')?>/"; //+'/'+property_cd+'/'+myBookId;
                    window.location.href = "<?php echo base_url('c_nup_cfld/edit_rev/N/')?>"+headerid; 
                    // window.location.href = "<?php echo base_url('c_nup_cfld/edit_rev/N/')?>"; 
        ...
        $('#btnBack').click(function() {
            ...
            var statusEdit = '<?php echo $statusEdit ?>';
            var Type_roi = '<?php echo $Type_roi ?>';
            // alert(Type_roi);
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(data, status){
                    window.location.href = "<?php echo base_url('c_nup_landed_cfld/indexEdit/')?>"+statusEdit+"/"+Type_roi;
                },
                error: function(jqXHR, textStatus, errorThrown){
                    swal(textStatus + ' Save : ' + errorThrown);
                }
...
function fn_change_box(Id,nup_counter,from){ 
    ...
    if(fn=='A'){
        ...
        // for (i = 0; i < arr_descs.length; i++) {
        //     if (arr_descs[i] != lot_descs && new_descs == ""){
        //         new_descs = arr_descs[i];
        //     } else if (arr_descs[i] != lot_descs && new_descs != ""){
        //         new_descs = new_descs + ',' + arr_descs[i];
        //     } 
        // }         
    ...
    // console.log(nup_counter);
        ...
        var chosen_unit = $('#lot_no2').val();        
         ...
         var modalClass = $('#modal').attr('class');
                        ...
                        $('#modal').data('property_cd',property_cd);
                        $('#modal').data('statusEdit',statusEdit);
...
function fn_search1(){
    ...
    var rowid = '<?php echo $rowID;?>';
    var property_cd = '<?php echo $property_cd;?>';
    var bb = '<?php echo base_url("c_nup_landed_cfld_dt/data_unit_landdtEdit");?>'+"/"+rowid+"/"+property_cd+"/";
...
function fn_search(){
    ...
    if(Type != ""){
        // where = "AND type='"+Type+"'";
        where = statusEdit+"/"+lot_no+"/"+Type;
    }
    if(Direction!=""){
        if(where !=""){
            where = where+"/"+Direction;
        }else{
            where = statusEdit+"/"+lot_no+"/null/"+Direction;
        }
    ...
    if(Price !=""){
        if(where !=""){
            ...
            where = statusEdit+"/"+lot_no+"/null/null/"+Price;
        }
    }
    // console.log(bb+where);
