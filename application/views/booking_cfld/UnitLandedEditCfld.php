...
function openPage(rowid,property_cd,statusEdit,Type,unit){
  
  // window.location.href="<?php echo base_url('c_nup_landed_cfld/data_unit_landdt')?>"+"/"+rowid+"/"+property_cd+"/"+unit;
  // window.location.href="<?php echo base_url('C_nup_landed_cfld_dt/data_unit_landdtEdit')?>"+"/"+rowid+"/"+property_cd+"/"+unit+"/"+headerid;
  window.location.href="<?php echo base_url('C_nup_landed_cfld_dt/data_unit_landdtEdit')?>"+"/"+rowid+"/"+property_cd+"/"+statusEdit+"/"+Type+"/"+unit;
...
$('#btnNext').click(function() {
            ...
            $.ajax({
                ...
                success: function(data, status) {
                    var busID = '<?php echo $business_id;?>';
                    // window.location.href = "<?php echo base_url('c_nup_cfld/edit_rev/N/')?>"; //+'/'+property_cd+'/'+myBookId;
