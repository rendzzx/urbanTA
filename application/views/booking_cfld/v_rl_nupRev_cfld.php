...
<div class="row border-bottom white-bg dashboard-header">  
          ...
          <form role="form" class="form-horizontal" enctype="multipart/form-data" id="form_nup" method ="POST" >
            <div class="ibox-content">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="select2_demo_1 form-control" name="country_cd" id="country_cd" data-placeholder="Select Country"></select>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  ...
                  <select class="select2_demo_2 form-control"  name="city" id="city" data-placeholder="Select City"></select>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <select class="select2_demo_1 form-control" name="Location" id="Location" data-placeholder="Select Location" style="width: 100%;">                    
                  </select>  
                </div>                
              </div>
             <!--  <div class="form-group">
  ...
  function nuptypeinfo(status)
  {
    ...
    var modalClass = $('#modal').attr('class');
                        ...
                        $('div.modal-body').load("<?php echo base_url("c_nup_cfld/showinfo");?>/"+ status);
  ...
  function setNUPType(Id, product){
    ...
    function setProperty(Id,prod){
        ...
        var site_url2 = '<?php echo base_url("c_nup_cfld/zoom_property_edit")?>';
            $.post(site_url2,
              {prod:prod,Id:Id},
              function(data,status) {
                $("#property").empty();
    ...
    function setLocation(Id){
        ...
        var site_url = '<?php echo base_url("c_nup_cfld/chosen_location")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#Location").empty();
    ...
    function setCity(Id){
      var site_url = '<?php echo base_url("c_nup_cfld/chosen_city")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#city").empty();
    ...
    function setReason(Id){
        ...
        var site_url = '<?php echo base_url("c_nup_cfld/chosen_reason")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#reason_cd").empty();
    ...
    function setcountrycd(Id){
        ...
        var site_url = '<?php echo base_url("c_nup_cfld/chosen_country")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#country_cd").empty();
    ...
    function setpayment(Id){
        var site_url = '<?php echo base_url("c_nup_cfld/chosen_payment")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#payment").empty();
  ...
  function setsalutation(Id){
        ...
        var site_url = '<?php echo base_url("c_nup_cfld/chosen_salutation")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#salutation").empty();
    ...
    function setnationality(Id){
        ...
        var site_url = '<?php echo base_url("c_nup_cfld/chosen_nationality")?>';
            $.post(site_url,
              {Id:Id},
              function(data,status) {
                $("#nationality").empty();
  ...
  //     var ID = '<?php echo $rowID;?>';
  //     // BootstrapDialog.alert('rowID '+ID);
  //     var site_urla = '<?php echo base_url("c_nup_cfld/show_e_data")?>'+'/'+ID;
...
          ajax:{ 
            url: '<?php echo base_url("c_nup_cfld/chosen_city_")?>', 
            dataType: 'json', 
            type: 'post', 
            delay: 1000, 
        ...
        $.post(site_url,
          ...
          function(data,status){
            ...
            // BootstrapDialog.alert(data);
             ...
             var url = '<?php echo base_url("c_nup_cfld/Index")?>';
