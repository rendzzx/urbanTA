    ...
    <div class="box-body">
      ...
      <div class="form-group">
        <label for="GroupDescs" class="control-label">Button Color</label>
          <!-- <input type="hidden" name="buttonclass" id="buttonclass"> -->
          <div class="form-group row">
            <div class="col-6">
              <div class="i-checks" >
                <input type="radio" name="buttonclass" id="purple-blue" value="purple-blue" checked> 
                <label for="purple-blue"><button type="button"  style="width: 130px;margin-top: 10px"  class="btn btn-bg-gradient-x-purple-blue">Purple blue</button></label> 
              </div>
              <div class="i-checks" >
                <input type="radio" name="buttonclass" id="purple-red" value="purple-red"> 
                 <label for="purple-red"><button type="button"  style="width: 130px;margin-top: 10px"  class="btn btn-bg-gradient-x-purple-red">Purple red</button></label>
              </div>
              <div class="i-checks" >
                <input type="radio" name="buttonclass" id="blue-green" value="blue-green"> 
                 <label for="blue-green"><button type="button"  style="width: 130px;margin-top: 10px"  class="btn btn-bg-gradient-x-blue-green">Blue green</button></label>
              </div>
            </div>
            <div class="col-6">
              <div class="i-checks" >
                <input type="radio" name="buttonclass" id="orange-yellow" value="orange-yellow"> 
                <label for="orange-yellow"> <button type="button" style="width: 130px;margin-top: 10px;padding-right: 0px;padding-left: 0px;" class="btn btn-bg-gradient-x-orange-yellow">Orange yellow</button></label>
              </div>
              <div class="i-checks" >
                <input type="radio" name="buttonclass" id="blue-cyan" value="blue-cyan"> 
                <label for="blue-cyan"><button type="button" style="width: 130px;margin-top: 10px" class="btn btn-bg-gradient-x-blue-cyan">Blue cyan</button></label> 
              </div>
              <div class="i-checks" >
                <input type="radio" name="buttonclass" id="red-pink" value="red-pink"> 
                 <label for="red-pink"><button type="button"  style="width: 130px;margin-top: 10px"  class="btn btn-bg-gradient-x-red-pink">Red pink</button></label>
              </div>
            </div>
          </div>
      </div>
