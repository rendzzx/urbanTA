...
<form id ="frmEditor" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
	<div id="panel3" class="row">
		...
		<div class="form-group">
			<label for="AgentName" class="col-md-8 control-label">Agent Name<FONT COLOR="RED">*</FONT></label>
			<div class="col-md-10">
				<input type="text" id="txtAgentName" name="txtAgentName" class="form-control"/>	
			</div>	                    	
		</div>
		<div class="form-group">
			<label for="IDNo" class="col-md-8 control-label">ID No<FONT COLOR="RED">*</FONT></label>
			<div class="col-md-10">
				<input type="text" class="form-control" id="txtIdNo" name="txtIdNo"/>	
			</div>	                    	
		</div>
		<div class="form-group">
			<label for="NPWP" class="col-md-8 control-label">NPWP<FONT COLOR="RED">*</FONT></label>
			<div class="col-md-10">
				<input type="text" class="form-control" id="txtNPWP" name="txtNPWP"/>	
			</div>	                    	
		</div>
		<div class="form-group">
			<label for="HomeAdd" class="col-md-8 control-label">Home Address<FONT COLOR="RED">*</FONT></label>
			<div class="col-md-10">
		...
		<div class="form-group">
			<label for="EmailAdd" class="col-md-8 control-label">Email Address<FONT COLOR="RED">*</FONT></label>
			<div class="col-md-10">
		...
		<div class="form-group">
			<label for="Mbl2" class="col-md-8 control-label">Mobile 2</label>
			<div class="col-md-10">
