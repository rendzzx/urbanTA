        ...
        <br>
            <div class="breadcrumbs-top float-md-right">
                <div class="breadcrumb-wrapper mr-1">
                    ...
                    <li class="breadcrumb-item active">Overtime Approve
                    </li>
...
$(document).ready(function () {
    var tblovertime = $('#tblovertime').DataTable( {
       "serverSide": true,
        "ajax":{
            "url":"<?php echo base_url('c_overtime_approve/getTable');?>",
    ...
    $('#editparam').click(function(){
        ...
        var site_url = '<?php echo base_url("c_overtime/cek_startOT/")?>';
        $.post(site_url,
            {ot_id:id},
...
$.post(site_url,
    ...
    function(datacnt,status) {
        ...
        if(datacnt == 'true') {
            ...
            $.ajax({
                url : "<?php echo base_url('c_overtime/Delete');?>",
                type:"POST",
                data: { Ot_Id: id },
                dataType:"json",
            ...
            $.ajax({
                ...
                success:function(event, data){
                    if(event.Error==false){
                        ...
                        .then(function(a){
                            window.location.href="<?php echo base_url('c_overtime_approve/index');?>";
                            block(false,'#tblovertime');
                        });
                    }
                    else {
...
$.post(site_url,
    ...
    function(datacnt,status) {
        ...
        if(datacnt == 'true') {
            ...
            $('div.modal-body').load("<?php echo base_url("c_overtime/edit");?>");
            var dd = $('#ov_date').val();
            $('#modal').data('ovdate', dd);
