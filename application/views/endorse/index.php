  ...
  <div class="content-wrapper">
     ...
     <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
           <br><br>
           <h3 class="content-header-title">Endorsement</h3>
        </div>
...
<script type="text/javascript">
  ...
  var table = $('#table').DataTable({
    "ordering": false,
    "ajax" : {
        "url" : "<?php echo base_url('C_endorse/gettable');?>",
        "type": "POST"
    },
    "columns": [
    ...
    var html = '<div class="card box-shadow-0 border-info">'+
                  '<div class="card-content collapse show">'+
                    '<div class="card-body">'+
                      ...
                      '<div class="row">'+
                        '<div class="col-sm-12">'+
                          '<button onclick="approval('+d.complain_no+',\'Approval\',\''+d.report_no+'\')" type="button" class="btn btn-glow btn-bg-gradient-x-blue-cyan btn-block">Approval</button>'+
                        '</div>'+
                      '</div>'+
                    '</div>'+
                  '</div>'+
  ...
  function approval(id,action,report){
    ...
    $('#modalbody').load("<?php echo base_url("c_endorse/add/");?>"+id+'/'+action+'/'+report);
    $('#modal').data('id', 0);
    $('#modal').modal('show');
    $('.modal-footer').hide()
  }
  ...
  function loadfilter(){
      $.getJSON("<?php echo base_url('C_endorse/getfilter');?>", function (data) {
