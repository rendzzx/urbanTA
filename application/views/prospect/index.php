...
$(function(){
   tblnup = $('#tblnup').DataTable({
            ...
            buttons: [                
                {
                    text: ' New ', className: "biru-bg fa fa-plus "+x, action: function (e) {
                        var site_url = '<?php echo base_url("c_prospect_cfld/insert/N")?>';
                ...
                },               
                {
                    ...
                    action: function () {
                      ...
                      // alert(ID);
                        ...
                        var site_url = '<?php echo base_url("c_prospect_cfld/insert")?>'+'/E/'+ID;
        ...
        "serverSide": true,
        "ajax":{
            "url":"<?php echo base_url('c_prospect_cfld/getTable');?>",  
        ...
        "columns": [
            ...
            // }, 
            {data:"name",name:"name"},
            {data:"media_descs",name:"media_descs"},
            {data:"prospect_city",name:"prospect_city"},            
...
<div class="content-wrapper">
    <div class="row border-bottom white-bg dashboard-header">  
        <div class="form-group">
            ...
            <div class="tittle-top pull-right"><b>Prospective Customer</b></div>
...
$var.="               window.location.href='".base_url("newsfeed/index")."'+'/'+project+'-'+projectName;";
$var.="                    }";
$var.="                },";
$var.="                {";
