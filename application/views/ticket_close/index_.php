                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10" style="margin: -10px 0px -50px -20px;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="button" class="btn btn-block btn-danger" id="approval" onclick="modal(<?php echo $key->complain_no?>,'Close')">Close</button>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function modal(id,action){
        ...
        $('div.modal-body').load("<?php echo base_url("c_ticket_close/add/");?>"+id+'/'+action);
