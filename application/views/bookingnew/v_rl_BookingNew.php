      ...
      <div class="col-xs-12">
        <form role="form" class="form-horizontal" enctype="multipart/form-data" id="form_nup" method ="POST" >
          <div class="ibox-content">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Reservation Type<FONT COLOR="RED">*</FONT></label>                
              <div class="col-sm-2">
                <select class="select2_demo_2 form-control"  name="reserv" id="reserv" onchange="changereserv()" ><?php echo $nuptype?></select>
              </div>
              <label class="col-sm-2 control-label">Amount<FONT COLOR="RED">*</FONT></label>
              <div class="col-sm-3">                  
                <input type="text" class="form-control col-sm-5" name="amount" id="amount" value="0" disabled="">
              </div>
              </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Remarks<FONT COLOR="RED">*</FONT></label>
              <div class="col-sm-7">                  
                <input type="text" class="form-control col-sm-5" name="remark" id="remark" placeholder="Your Remarks">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Upload Document</label>
              <div class="col-sm-7">
                <input type="hidden" name="seqno" value="<?php echo $descs;?>" id="seqno">                
                ...
                <table id="tblattach" class="display table-striped" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td>1</td>
                    <td>KTP</td>
                    <td><img src="" id='ktp'  width="100px"></td>
                  ...
                  <tr>
                    <td>2</td>
                    <td>NPWP</td>
                    <td><img src="" id="npwp" width="100px"></td>
                  ...
                  <tr>
                    ...
                    <td><img src="" id="bukti" width="100px"></td>
  ...
  <script type="text/javascript">
    ...
    $('#disc').select2({
     ...
     $('#reserv').select2({
      ...
      //  ktp = localStorage.getItem('ktp')
      //  npwp = localStorage.getItem('npwp')
      //  bukti = localStorage.getItem('bukti')
      //  console.log(ktp);
...
function UploadImage(rowid,el){
  ...
  function upload(type){
    var modalClass = $('#modal').attr('class');
                ...
                // alert(rowID);
                $('div.modal-body').load("<?php echo base_url('booking/addNew');?>"); //+"/"+descs+"/"+rowID);
 ...
 //    });
  $('#btnView').click(function(){
    ...
    var payment_descs = $("#payment option:selected").text();
                ...
                // alert(rowID);
                $('div.modal-body').load("<?php echo base_url('booking/LotPriceList');?>"); //+"/"+descs+"/"+rowID);
                // $('#modal').data('descs', descs);
    ...
    if($('#form_nup').valid())
      {
        ...
        document.getElementById('hahaload').hidden=false; 
        var unit = localStorage.getItem('data');
        ...
        var site_url = "<?php echo base_url('booking/savenup')?>";
        $.ajax({
          url: site_url,
          type: "POST",
          data: dataform,
           ...
           document.getElementById('hahaload').hidden=true; 
            ...
            if(data.status !='Failed'){
                  ...
                  function(){
                    ...
                    window.location.href="<?php echo base_url('booking/index');?>"
