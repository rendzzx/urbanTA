...
<script type="text/javascript">
    ...
    function Clear() {
        ...
        window.location.href = "<?php echo base_url('c_reservarion/index')?>"+'/'+type+'/'+property_cd;
                // console.log(data.Pesan);
...
function openPage(rowid,property_cd,unit){
  // alert(rowid);
  window.location.href="<?php echo base_url('c_stepbooking/data_unit_landdt')?>"+"/"+rowid+"/"+property_cd+"/"+unit;
