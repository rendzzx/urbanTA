...
<form id ="frmEditor" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
    <div class="box-body">
        <div class="form-group">
            <label for="subjectnewsfeed" class="col-xs-2">Title</label>
            <div class="col-xs-8">
...
// ------------------------ end function loading
    ...
    function loaddata(){
        var id = $('#modal').data('id');
            ...
            if (id > 0) {
                ...
                $.getJSON("<?php echo base_url('c_gallery/getByID');?>" + "/" + id, function (data) {
    ...
    $(document).ready(function(){
      ...
      highlight: function (element, errorClass, validClass) {
        ...
        $('#userfile').fileupload({
            url: "<?php echo base_url('c_gallery/save_gallery');?>",
            dataType: 'json',
            add: function (e, data) {
                jqXHRData = data
                isFile = true;                
                ...
                tblgallery.ajax.reload(null,true); 
