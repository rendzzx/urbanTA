...
$(document).ready(function () {
    ...
    $('#userfile').fileupload({
            url: "<?php echo base_url('c_ticket_history/savePic');?>",
            dataType: 'json',
            // data:{'no':i},
            add: function (e, data) {
                jqXHRData = data
                ...
                // if(i == (batas-1)){
                  ...
                  if(res.status =='OK'){
                      ...
                      //     });
                                ...
                                document.getElementById("picturebox"+nourut).src=dataUrl;
                                console.log(sn);
                                $('#picturename'+nourut).val(res.picname);
                                $('#modal').modal('hide');
                  }else{
                       swal({
                              title: "Warning",
