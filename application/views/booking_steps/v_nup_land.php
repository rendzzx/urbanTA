...
function back(){
 ...
 window.location.href="<?php echo base_url('c_nup_landed/indextipe/')?><?php echo $ptype?>/<?php echo $pcd ?>/";
}
function tes() {
  window.location.href="<?php echo base_url('c_booking_landed/indextipe/')?><?php echo $ptype?>/<?php echo $pcd ?>";
        ...
        var default_options =
        {
            ...
            onClick: function (e) {
                ...
                $(this).parent().parent().find("area").each(function(){
                    ...
                    // } else {
                      if(unit == e.key ){
                        fn_change_box(e.key,nupcount,$(this));
                      }
                    // } 
  ...
  { 
    ...
    // alert(pcd);
         var modalClass = $('#modal').attr('class');
                        ...
                        // alert(property_type);
                        // alert(pcd);
                        $('div.modal-body').load("<?php echo base_url("c_booking_landed/showland");?>"+"/"+data+"/"+property_type+"/"+pcd);
