      ...
      <div class="col-xs-12">
        <form role="form" class="form-horizontal" enctype="multipart/form-data" id="form_nup" method="POST" >
          ...
          <div class="box-footer" align="left">
            ...
            <input type="button" name="btnback" id="btnback" value="Back" data-dismiss="modal" class="btn btn-default">
...
 
  ...
  loaddata();
  function back(){
    window.location.href="<?php echo base_url('c_customer_info/index')?>";
    // window.history.go(-1);
  }
  ...
  $("#btnAdd").click(function() 
  {
    ...
    for (var i = xx; i <= xx; i++) 
    {
      ...
      $("#tabbody-"+i).append('<div class="form-group" id="desc_div'+i+'"><label class="col-sm-3">Description  </label><div class="col-sm-7"><textarea class="form-control" placeholder="Input Work Request" name="work_req'+i+'" id="work_req'+i+'" style=" height: 50px;"></textarea></div></div>');
...
$('input[name=ticket_type]').on('click',function(e){
  if (document.getElementById('C').checked) { 
    ...
    function loaddata(){
      ...
      // console.log(rowid);
      $.getJSON("<?php echo base_url('c_customer_info/getTicketByID');?>" + "/" + rowid, function (data) {
              console.log(data);
