    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="box box-info">
          ...
          <?php echo $data['error']; ?>
          <div class="box-body">
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>ticket/saveProc">
                 <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <div class='input-group date' id='datetimepicker'>
                            <input type='text' class="form-control" value="<?php echo $complain->est_completion_date ?>" name="est_date" id="est_date" readonly="readonly"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control" rows="3" name="remarks" readonly="readonly"><?php echo $complain->remarks ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPos3" class="col-sm-2 control-label">Problem Cause</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" rows="3" name="problem_cause" readonly="readonly"><?php echo $complain->problem_cause ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPos3" class="col-sm-2 control-label">Date Completed</label>
                      <div class="col-sm-5">
                        <div class='input-group date' id='datetimepicker2'>
                            <input type='text' class="form-control" name="cmplt_date" id="cmplt_date" />
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                                <!-- <span class="glyphicon glyphicon-calendar"></span> -->
                            </span>
                    ...
                    <div class="form-group">
                      <label for="inputPos3" class="col-sm-2 control-label">Action Taken</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" rows="3" name="actiontaken" Placeholder="Action Taken"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPos3" class="col-sm-2 control-label">Items/ Service Used</label>
                      <div class="col-sm-10">
                          ...
                          <table class="table no-margin">
                            <thead>
                              <tr>
                                ...
                                <th style="width: 24px;">Currency</th>
                                <th style="width: 24px;">Cost</th>
                              </tr>
                            </thead>
                            <tbody>
                              <?php 
                                if (!empty($list_needed)) {
                                  echo $list_needed;
                                }
                              ?>
                            </tbody>  
