<div class="content-wrapper" style="min-height: 221px;">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ticket Confirm</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="box box-info">
          ...
          <?php echo $data['error']; ?>
          <div class="box-body">
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>ticket/saveCnf">
                 <div class="box-body">
                  <!-- 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" value="<?php echo $complain->assign_to?>" name="assignto" />
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     <label for="inputPos3" class="col-sm-2 control-label">Feedback</label>
                     <div class="col-sm-10">
                       <textarea class="form-control" rows="3" placeholder="Feedback" name="feedback"></textarea>
                     </div>
                    </div>
                    <!-- <div class="form-group">
