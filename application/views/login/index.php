                               ...
                               <?php echo validation_errors(); ?>
                                ...
                                <!-- <div class="col-md-6 col-10"  id="inner"> -->
                                    <div class="card-body" style="width: 70%" id="inner">
                                        ...
                                        <form class="form-horizontal" id="frm1" action="<?php echo base_url(); ?>userStaff/login" method="post" width="40%">
                                            <script type="text/javascript">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12 col-12 float-sm-left text-center text-sm-right"><a href="#" onclick="fn_confirm();" class="card-link" style="color: #ffffff">Forgot Password?</a></div>
                                            </div> 
                                            <div id="error_msg">
