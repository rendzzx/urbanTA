...
// ------------------------ end function loading
    ...
    function loaddata(){
        var id = $('#modal').data('id');
            ...
            if (id > 0) {
                $.getJSON("<?php echo base_url('c_pmlevel/getByID');?>" + "/" + id, function (data) {
    ...
    $(document).ready(function(){
       ...
       $(document).on('hidden.bs.modal', '#modal', function () {
            ...
            $("#savefrm_level").prop('disabled', false)
        });
        ...
        $('#userfile').bind('change', function() {
            ...
            if (size>=max_size) {
                ...
                $("#savefrm_level").prop('disabled', true)
                $('#picturebox').attr('src', '');
            }
            else{
                $("#savefrm_level").prop('disabled', false)
        ...
        $('#userfile').fileupload({
            url: "<?php echo base_url('c_pmlevel/save_level');?>",
            dataType: 'json',
            add: function (e, data) {
                jqXHRData = data
                isFile = true;                
                ...
                tbllevel.ajax.reload(null,true); 
