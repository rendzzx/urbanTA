...
<head>
  ...
  <!-- <link rel="stylesheet" href="<?=base_url('css/test/bootstrap.min.css')?>"> -->
  

  <!--<script src="<?=base_url('css/test/jquery.min.js')?>" type="text/javascript"></script>-->
  <!--<script src="<?=base_url('css/test/bootstrap.min.js')?>" type="text/javascript"></script>-->
                    ...
                    <div class="col-sm-7">
                      <input class="form-control" name="rsvdate" id="rsvdate" value="<?php echo($today)?>" disabled="1">
                       ...
                       <!--  <div class="form-group" >
                          ...
                          <div class="col-sm-7">
                            <select class="select2 required form-control" name="Location" id="Location" data-placeholder="Select Location"><?php echo $comboLocation; ?></select>                  
                          </div>
                        </div> -->
                        <div class="form-group">
