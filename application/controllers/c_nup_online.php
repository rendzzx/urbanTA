...
class C_Nup_Online extends Core_Controller {
	...
	public function index()
    {
        ...
        $this->load_content_top_menu('nup_online/NupOnline', $ContentAllData);
    }
	...
	public function getTable($product_cd='')
    {
       ...
       $entity = $this->session->userdata('Tsentity');
        ...
        $aColumns  = array('rowID','nup_type', 'descs','start_date','end_date', 'nup_amt', 'expired_minute');
        // $aColumns = array('entity_cd', 'entity_name');
        $sTable = 'mgr.rl_nup_type';
    ...
    public function Delete(){
        ...
        if($data !="OK"){
            ...
            $psn ="OK";
                ...
                $data = $this->m_wsbangun->deletedataweb('rl_nup_type',$where);
                $msg = "Data has been deleted successfully";
     ...
     public function save(){
            ...
            if ($_POST) 
            {
                ...
                $badges = $this->input->post('btn_badge',TRUE);
                // var_dump($start);
                // var_dump($end);exit();
