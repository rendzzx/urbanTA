...
class c_assignmenu_approval extends Core_Controller
{
    ...
    public function index()
    {
        ...
        // 
        // MenuID == group_descs
        $sql = "SELECT distinct group_cd,group_descs from mgr.sysGroupAppr(nolock)";
        // var_dump($sql);exit;
        ...
        $this->load_content_top_menu('menu_approval/assignmenu_approval', $content);
    }
    ...
    public function getTable()
    {
        ...
        // $param = "";
        $rResult = $this->m_wsbangun->getListAssignAdmAssign($sTable,(int)($iDisplayStart),(int)($iDisplayLength),$SordField,$SortdOrder,$param);
    ...
    public function getList()
    {
        if($_POST)
        {
            ...
            $table = 'sys_menu_approval_group';
            $crit = array('Group_Cd'=>$gid);
