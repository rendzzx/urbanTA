...
class C_creditor_summary extends Core_Controller
{
	...
	public function index(){
        ...
        $sql="select distinct creditor_acct, creditor_name from mgr.v_ap_creditor_aging_sum(NOLOCK) where entity_cd='".$entity."' order by creditor_name";
    ...
    if ($group=='MGM'){
            $this->load_content_mgm('list_creditor/indexsummary',$ContentAllData);
        }else{
            $this->load_content_top_menu('list_creditor/indexsummary',$ContentAllData);
        }
    }
    ...
    public function getTable(){
        ...
        $aColumns = array('row_number','creditor_name');

        $sTable = "mgr.v_ap_creditor_aging_sum";
