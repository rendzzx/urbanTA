...
class C_menu_mobile extends Core_Controller
{
    ...
    public function index()
    {
    	...
    	$this->load_content_top_menu('menu_mobile/index',$content);
    }
...
//         $comboParentID = $this->m_wsbangun->getCombo($table, $object);
    ...
    public function addnew(){
        ...
        $this->load->view('menu_mobile/add', $content);
    ...
    public function getByID($MenuID=''){
        ...
        $data = $this->m_wsbangun->getData_by_criteriapb('sysMenuMobile',$where);
    ...
    public function getTable()
    {
        ...
        $aColumns  = array('row_number', 'MenuID','Title', 'URL', 'ParentMenuID', 'IconClass', 'title_descs');
                ...
                if(empty($parent_id)){
                    ...
                    if($menu_id>0) {
                     ...
                     //   $this->m_user_log->insert(add_user_log("newsfeed Name " . $newsfeed_name, $this->m_users->get_by_uname($this->session->userdata('uname')), $this->m_activities->get_by_title("ADD newsfeed")));
                        ...
                        $data = $this->m_wsbangun->insertDataweb('sysMenuMobile',$data);
                        if($data !="OK"){
                            $msg= $data;
                            $st = 'Fail';
                        }else{
