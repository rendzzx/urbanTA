...
class C_Lottyped extends Core_Controller
{
    ...
    public function add(){
        ...
        $query = "SELECT cluster_cd, descs from mgr.pl_cluster where entity_cd='$entity' and project_no='$project'";
        $cluster = $this->m_wsbangun->getData_by_query_cons($cons,$query);
