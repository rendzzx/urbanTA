...
class overtime extends Core_Controller
{
...
public function zoom_lot_no_in($debtor_acct=''){
    ...
    public function getTableOpen()
    {
        ...
        $param = " where ot_id > 0 and entity_cd='$entity' and project_no='$project'  and approved='N' and status_posting='N' and start_overtime>=getdate() ".$filter_search;
        // var_dump($param);
    ...
    public function getTableExpired()
    {
        $project = $this->session->userdata('Tsproject');        
