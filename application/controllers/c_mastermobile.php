...
class C_Mastermobile extends Core_Controller
{
    ...
    public function index()
    {
        ...
        $this->load_content_top_menu('mastermobile/index',$content);
    }
    ...
    public function add(){
        ...
        $this->load->view('mastermobile/add',$content);
    ...
    public function getTable()
    {
        ...
        $aColumns  = array('row_number','line_no','gallery_url', 'gallery_title');
    ...
    public function save_gallery(){
        ...
        if($_POST){
            ...
            $table = 'rl_project_gallery';
            $sql="select count(*) as cnt from mgr.rl_project_gallery";
            ...
            if($id > 0) {
                $data = array(
                'gallery_title' => $title,
                'gallery_url' => base_url('img/gallery/').$image,
