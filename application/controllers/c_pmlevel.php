...
class C_Pmlevel extends Core_Controller
{
    ...
    public function add(){
        ...
        $this->load->view('pmlevel/add',$content);
    ...
    public function getTable()
    {
        ...
        $aColumns  = array('row_number','descs','picture_url');
    ...
    public function save_level(){
        ...
        if($_POST){
            if($isFile=="true"){
                ...
                if (!is_dir("./img/unitinfo/".$project."/level/")) {
                    mkdir("./img/unitinfo/".$project."/level/");
                }

                $target_dir = "./img/unitinfo/".$project."/level/";
            ...
            if(strpos($image, base_url('img/unitinfo/'.$project.'/level/')) !==false ) {
                $data = array(
                'picture_url' => $image,
                ...
                $data = array(
                'picture_url' => base_url('img/unitinfo/'.$project.'/level/').$image,
                'audit_user'=>$audit_user,
                'audit_date'=>$audit_date
                );
            }
