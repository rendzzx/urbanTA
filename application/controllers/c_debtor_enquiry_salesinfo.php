...
class c_debtor_enquiry_salesinfo extends Core_Controller
{
    ...
    public function getTableSalesinfo()
    {
        ...
        $aColumns  = array('row_number','lot_no', 'debtor_acct','sales_date','hand_over_date', 'AJB_date', 'key_collection_date', 'sell_price');
        // $aColumns = array('entity_cd', 'entity_name');
        $sTable = 'mgr.v_rl_sales';
