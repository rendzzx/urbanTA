...
class C_Reservation extends Core_Controller {
    ...
    // 			'project_no'=>$project,
    	...
    	$this->load_content_top_menu('reservation/NupIndex',$ContentAllData);
    }
  ...
  //       $cnt = $this->check_attachment($seqno,'IN');
	...
	public function edit_rev($status='',$rowID='')
	{
        ...
        $this->load_content_top_menu('reservation/v_rl_BookingNew',$content);
    }
  ...
  //       $prjName = empty($dtPrj) ? '' : $dtPrj[0]->descs;
	...
	function insert2($property_type=null,$property_cd=null,$unit=null){
        ...
        if(!empty($property_type) && !empty($property_cd)){
            if($property_type=='A'){
                ...
                $this->load_content_top_menu('reservation/SB2UnitFloor',$data);
            }else if($property_type=='L'){
                $data = $this->data_unit_landed($property_cd,$property_type,$unit);
                $this->load_content_top_menu('reservation/SB2UnitLanded',$data);
            }
            
        }else{
            $this->load_content_top_menu('reservation/SB1',$data);  
        }
	}
	...
	public function property_image(){
        ...
        $data = array('property_type'=> $ListAllData);
            $this->load->view('reservation/property_type',$data);
        }
    ...
    public function indextipe($property_cd=null)
    {
            ...
            $backurl = base_url("c_reservation/insert2");     
            ...
            $this->load_content_top_menu('reservation/v_nup_landed', $Content);
     ...
     public function indexland($entity = null, $project = null,$pcd=null,$level=null)    
        {
            ...
            $this->load_content_top_menu('reservation/v_nup_land', $Content);
        }
        ...
        public function showland($lotno = null,$lot_type=null)
    {
        ...
        $content = array(
            ...
            $this->load->view('reservation/infoaptnew',$content);//apart
    ...
    public function AddpayAndCust($unit=null,$property_cd=null,$rowID=0){
        ...
        // var_dump($this->session->userdata('Tsuname'));exit();
        ...
        // $table = 'agent_details';
        // $crit = array('userid'=>$user);
        // $agent = $this->m_wsbangun->getData_by_criteria_cons($cons,$sql,$crit);
        // // var_dump($agent);exit();
        // if(!empty($agent)){
    ...
    public function addNew()//($dt=null, $row=null)
    {
        ...
        $this->load->view('reservation/v_booking_upload');
    }
  ...
  //       return $cnt;
   ...
   //      echo json_encode($msg1);
        ...
        $audit_date = date("d M Y H:i:s");
        // $min = "+".$reserv->expired_minute." minutes";
        // $expired_time = date('d M Y H:i:s',strtotime($min,strtotime($audit_date)));

        // if($rowID != 0){
        //     // var_dump('edit');exit;
        //     //edit
        //     $dataUpdCfBusiness = array(
        //         'nationality' => $nationality,
        //         'name' => $user,
        //         'ic_no' => $noktp,
        //         'remark' => $remark,
        ...
        //     $wherecf = array('business_id' => $data->businessID);

        //     $cf = $this->M_wsbangun->updateData($cons,"cf_business",$dataUpdCfBusiness,$wherecf);
        ...
        //             'nup_amt' => $reserv1[3],
        //             'link_ktp' => $pict->imgID,
        //             'link_npwp' => $pict->imgNPWP,
        //             'link_bukti_transfer' => $pict->imgTF
        //         );

        //         $whereRess = array('rowID' => $rowID);

        //         $res = $this->M_wsbangun->updateData($cons,"rl_reserve_nup",$dataUpdReserve,$whereRess);
