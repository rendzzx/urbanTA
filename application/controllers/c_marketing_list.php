...
class C_marketing_list extends Core_Controller {
	...
	public function index(){
        ...
        $sql2 = "SELECT DISTINCT group_cd from mgr.cf_agent_dt (NOLOCK) where agent_cd='$name' and ENTITY_CD='$entity'";
        ...
        $sql = "SELECT DISTINCT group_name from mgr.v_executive_mkt (NOLOCK) Where group_cd='$groupcode' AND entity_cd='$entity'";
        $cons = $this->session->userdata('Tscons');
    	...
    	$this->load_content_top_menu('marketing_list/index',$ContentAllData);
	}
	...
	public function edit(){
        ...
        $this->load->view('marketing_list/add');
	}
	...
	public function getTable()
    {
        ...
        $aColumns  = array('rowID','agent_name','email_add','handphone1', 'npwp', 'home_address', 'city', 'handphone2');
        ...
        $SordField = ($sortIdColumn==0? 'rowID' :$Column[$sortIdColumn]['agent_name']);
...
// var_dump($Search);
        ...
        $param =" Where rowID > 0 AND status_approval = 'A'".$filter_search;
