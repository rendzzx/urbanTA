...
class C_debtor_summary extends Core_Controller
{
    ...
    if ($group=='MGM'){
            $this->load_content_mgm('list_debtor/indexsummary',$ContentAllData);
        }else{
            $this->load_content_top_menu('list_debtor/indexsummary',$ContentAllData);
        }
    }
    ...
    public function getTable(){
        ...
        $sTable = "mgr.v_ar_debtor_aging_summary_currency";
