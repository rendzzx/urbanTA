...
class C_User_Splus extends Core_Controller
{
    ...
    {
        $this->load_content_top_menu('user_splus/index');
    }
    ...
    public function gettable($group)
    {
        ...
        $param = " where rowID > 0 and Group_Cd ='$group' ".$filter_search;
        // var_dump($param);
    ...
    public function adduser()
    {
    	...
    	$this->load->view('user_splus/add',$content);
    }
    public function activate()
    {
        ...
        $this->load->view('user_splus/activate',$content);
    }
