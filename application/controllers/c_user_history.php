...
class c_user_history extends Core_Controller{
    ...
    public function index(){
        ...
        $this->load_content_top_menu('user_history/index',$content);
    }
    ...
    public function addnew($id=""){
        ...
        $this->load_content_top_menu('user_history/addproject',$content);
    }
    ...
    public function getTable(){
        ...
        $aColumns  = array('row_number','email','login_type', 'ipAddress', 'device', 'login_date');
        // $aColumns = array('entity_cd', 'entity_name');
        $sTable = 'mgr.sysusersessionlog';
        ...
        $SordField = ($sortIdColumn==0? 'email' :$Column[$sortIdColumn]['name']);
        $param='';
        $filter_search='';
