...
class C_Nup extends Core_Controller {
  ...
  //       echo $data;
	...
	public function showinfo()
	{
		...
		$sql = "select nup_type_info from mgr.rl_nup_spec where entity_cd ='$entity' and project_no = '$project'";
  ...
  //       $prjName = empty($dtPrj) ? '' : $dtPrj[0]->descs;
	...
	public function insert($status='') 
	{
		...
		// $sqlcb = "select * from mgr.listcity order by rowid";
  //       $cbCity = $this->m_wsbangun->getData_by_query($sqlcb);
  //       // var_dump($entityName);
  //           if(!empty($cbCity)) {
  //               $comboCity[] = '<option></option>';
  ...
  //               //     $selected = '';
  //               // }
  //                   $comboCity[] = '<option value="'.$dtCity->city.'">'.$dtCity->city.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '.$dtCity->province.'</option>';
  //               }
  //               $comboCity = implode("", $comboCity);
  //           }
