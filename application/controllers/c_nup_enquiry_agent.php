...
class C_nup_enquiry_agent extends Core_Controller {
	...
	public function index(){
    	...
    	$this->load_content_top_menu('nup_enquiry_new/index',$ContentAllData);
	}
    ...
    public function index_admin(){
        ...
        $this->load_content_top_menu('nup_enquiry_new/index_admin',$ContentAllData);
    }
	...
	public function view($rowID=null){
        ...
        $this->load->view('nup_enquiry_new/view',$content);
	}
 ...
 //        return $cnt;
	...
	public function getTable(){
       ...
       $entity = $this->session->userdata('Tsentity');
        ...
        $aColumns  = array('rowID', 'NAME', 'nup_no', 'Handphone', 'Email', 'nup_type', 'reserve_date', 'agent_name', 'STATUS','product_type');
...
// var_dump($Search);
    ...
    public function getTable_admin(){
        $sSearch = $this->input->post("sSearch",true);
        if(empty($sSearch)){
            $sSearch='';
        }
