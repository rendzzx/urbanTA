...
class C_Feature extends Core_Controller
{
    ...
    public function index()
    {
        ...
        $this->load_content_top_menu('feature/index',$content);
    }
    ...
    public function add(){
        ...
        $this->load->view('feature/add',$content);
    ...
    public function getTable()
    {
        ...
        $aColumns  = array('row_number','feature_info');
        // $aColumns = array('entity_cd', 'entity_name');
        $sTable = 'mgr.rl_project_feature';
    ...
    public function save_feature(){
        ...
        if($_POST){
            ...
            $id = $this->input->post('idfeature', TRUE);
