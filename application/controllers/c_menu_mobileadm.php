...
class C_menu_mobileadm extends Core_Controller
{
    ...
    public function index()
    {
    	...
    	$this->load_content_top_menu('menuadm/index',$content);
    }
...
//         $comboParentID = $this->m_wsbangun->getCombo($table, $object);
    ...
    public function getByID($MenuID=''){
        ...
        $data = $this->m_wsbangun->getData_by_criteria('sysMenu',$where);
