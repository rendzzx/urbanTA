...
class C_debtor_detail extends Core_Controller
{
    ...
    if ($group=='MGM'){
            $this->load_content_mgm('list_debtor/indexdetail',$ContentAllData);
        }else{
            $this->load_content_top_menu('list_debtor/indexdetail',$ContentAllData);
        }
    }
    ...
    public function getTable(){
        ...
        $sTable = "mgr.v_ar_debtor_aging_detail_currency";
