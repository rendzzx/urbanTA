...
class c_debtor_enquiry_reminder extends Core_Controller
{
    ...
    public function goto_tab($debtor_acct='',$tab=''){
        ...
        if($tab=='tab-1'){
            ...
            $tes = 'debtor_enquiry_reminder/Reminder';
        }
   ...
   public function getTableReminder()
    {
        ...
        $aColumns  = array('row_number', 'trx_type','doc_no','doc_date','due_date','reminder_no','reminder_date','currency_cd','reminder_amt');
        // $aColumns = array('entity_cd', 'entity_name');
        $sTable = 'mgr.v_ar_remind_tmp';
