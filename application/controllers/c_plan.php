...
class C_Plan extends Core_Controller
{
    ...
    public function index()
    {
        ...
        $this->load_content_top_menu('plan/index',$content);
    }
    ...
    public function add(){
        ...
        $this->load->view('plan/add',$content);
    ...
    public function getTable()
    {
        ...
        $aColumns  = array('row_number','line_no','plan_url','plan_title','plan_url');
        // $aColumns = array('entity_cd', 'entity_name');
        $sTable = 'mgr.rl_project_plan';
    ...
    public function save_plan(){
        ...
        $tables = 'rl_project_plan';
        $sql="select count(*) as cnt from mgr.rl_project_plan";
        ...
        if($_POST){
            if($isFile=="true"){
                ...
                if (!is_dir("./img/projectinfo/".$project."/plan/")) {
                    mkdir("./img/projectinfo/".$project."/plan/");
                }

                $target_dir = "./img/projectinfo/".$project."/plan/";
                ...
                if($id > 0) {
                    if(strpos($image, base_url('img/projectinfo/'.$project.'/plan/')) !==false ) {
                        $data = array(
                        'plan_title' => $title,
                        'plan_url' => $image,
                        ...
                        $data = array(
                        'plan_title' => $title,
                        'plan_url' => base_url('img/projectinfo/'.$project.'/plan/').$image,
                        'audit_user'=>$audit_user,
                        'audit_date'=>$audit_date
                        );
                    }
    ...
    public function Delete(){
        ...
        $where=array('rowID'=>$id);
        $data = $this->m_wsbangun->deletedata_cons($cons,'rl_project_plan',$where);
